...
/** The interface to use for in-game and system chat. */
...
struct native UniqueNetId
{
	...
	structcpptext
	{
		...
		{
#if WITH_PANORAMA || XBOX || WITH_STEAMWORKS || WITH_MCTS //$$MCTS
...
/**
 * Called from native code to assign the in-game chat interface
 *
 * @param NewInterface the object to assign as providing the in-game chat interface
 *
 * @return TRUE if the interface is valid, FALSE otherwise
 */
