...
defaultproperties
{
   ...
   Name="Default__ParticleModuleLocationPrimitiveCylinder_Seeded"
   ObjectArchetype=ParticleModuleLocationPrimitiveCylinder'Engine.Default__ParticleModuleLocationPrimitiveCylinder'
}
