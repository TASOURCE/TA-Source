...
//$$BE Put the friendly fire flag here so it's fast to access without casting in script.
var bool r_bFriendlyFire;
...
{
	if ( bNetDirty )
		bStopCountDown, Winner, bMatchHasBegun, bMatchIsOver, r_bFriendlyFire;
...
{
   bStopCountDown=True
   ServerName="Tribes Ascend Server"
