...
defaultproperties
{
   AutomatedMapTestingList(0)="CTF-Hydrosis"
   AutomatedMapTestingList(1)="TrRabbit-Defiance"
   AutomatedMapTestingList(2)="TrCTF-Kargo"
   AutomatedMapTestingList(3)="WAR-Avalanche"
   AutomatedMapTestingList(4)="WAR-Torlan"
   NumMinutesPerMap=50
