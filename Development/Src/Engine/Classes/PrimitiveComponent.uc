...
//$$ MJD June 2011 Server Performance
var const native transient int ThreadTag[7];
...
//$$BE Added in PlayerShadowFadeResolution.
/** If false, uses ShadowFadeResolution in system settings where applicable. Otherwise uses PlayerShadowFadeResolution. */
var(Lighting)   bool        bUsesPlayerShadowFadeResolution;
