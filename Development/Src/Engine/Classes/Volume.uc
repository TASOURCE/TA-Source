...
cpptext
{
	...
	INT EncompassesRotatedExtent(FVector Center, FRotator Rotation, FVector Extents);  //$$BE Allow for checking not just the point, but the point and extents (rotated) as well.
	void SetVolumes();
