 ...
 *
 */
native(231) final static private function LogInternal( coerce string S, optional name Tag );
 ...
 */
native(232) final static private function WarnInternal( coerce string S );
