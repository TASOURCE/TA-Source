...
state Defending
{
	...
	function SetRouteGoal()
	{
		...
		if ( RouteGoal != None )
		{
			bCanDetour = (Vehicle(Pawn) == None);//TGFIXUP || (UTVehicle_Hoverboard(Pawn) != None);
...
defaultproperties
{
   ...
   Begin Object Class=UDKAIDecisionComponent Name=TheDecider Archetype=UDKAIDecisionComponent'UDKBase.Default__UDKBot:TheDecider'
      Name="TheDecider"
      ObjectArchetype=UDKAIDecisionComponent'UDKBase.Default__UDKBot:TheDecider'
   End Object
   ...
   Name="Default__UTBot"
   ObjectArchetype=UDKBot'UDKBase.Default__UDKBot'
}
