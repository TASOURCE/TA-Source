...
function SetVisible(bool bNewVisible)
{
    ...
    //$$ML: This was causing log spam.
    if( HudMovie.Minimap != None )
    {
...
event DrawHUD()
{
	...
	//$$BE This is called every tick in TrHUD
...
defaultproperties
{
   MinimapHUDClass=Class'UTGame.GFxMinimapHud'
   bEnableActorOverlays=True
   Name="Default__UTGFxHudWrapper"
   ObjectArchetype=UTHUDBase'UTGame.Default__UTHUDBase'
}
