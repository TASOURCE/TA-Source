...
var GFxObject RootMC, PauseMC, OverlayMC, Btn_Resume_Wrapper, Btn_Exit_Wrapper, Btn_Family_Wrapper;
...
function bool Start(optional bool StartPaused = false)
{
    ...
    Btn_Family_Wrapper = PauseMC.GetObject("family_btn_mc");
