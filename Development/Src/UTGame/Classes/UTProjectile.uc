...
//$$BE
/** Whether the ProjEffects should be deleted on Destroy */
var bool m_bDestroyProjEffects;
 ...
 */
//$$BE Added support for custom explosion sounds.
...
simulated function SpawnExplosionEffects(vector HitLocation, vector HitNormal)
{
	...
	{
		//$$BE Added usage of new hit location and normal based off of the object hit.
			...
			if ( /*!WorldInfo.bDropDetail && */((ExplosionLightClass != None) || (ExplosionDecal != none)) && ShouldSpawnExplosionLight(HitLocation, HitNormal) )
			{
				...
				if (ExplosionDecal != None && Pawn(ImpactedActor) == None && HitActor != none )
				{
					if( MaterialInstanceTimeVarying(ExplosionDecal) != none )
					{
						...
						//$$BE Unhack the hack! UNHACK THE GIBSON!!!!!
						else
						{
		...
		//$$BE Support for different hit-material explosion FX sounds
...
simulated function Destroyed()
{
	...
	if (ProjEffects != None && m_bDestroyProjEffects)
	{
...
defaultproperties
{
   m_bDestroyProjEffects=True
   bAttachExplosionToVehicles=True
   DurationOfDecal=24.000000
   DecalDissolveParamName="DissolveAmount"
   MaxEffectDistance=10000.000000
   GlobalCheckRadiusTweak=0.500000
   ...
   Begin Object Class=CylinderComponent Name=CollisionCylinder Archetype=CylinderComponent'UDKBase.Default__UDKProjectile:CollisionCylinder'
      CollisionHeight=0.000000
      CollisionRadius=0.000000
      ReplacementPrimitive=None
      Name="CollisionCylinder"
      ObjectArchetype=CylinderComponent'UDKBase.Default__UDKProjectile:CollisionCylinder'
   End Object
   ...
   ObjectArchetype=UDKProjectile'UDKBase.Default__UDKProjectile'
}
