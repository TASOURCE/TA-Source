...
// Lower level hook to get into the GFx version.
...
function bool CheckCrosshairOnFriendly()
{
	...
	if ( (HitV != None) && (HitV.Health < HitV.default.Health) && ((V != None) ? false : false)) //TGFIXUP (UTWeap_Linkgun(W) != None)) )
	{
...
defaultproperties
{
   ...
   ConfiguredCrosshairScaling=1.000000
   ...
   Name="Default__UTHUDBase"
   ObjectArchetype=UDKHUD'UDKBase.Default__UDKHUD'
}
