...
//$$ML: Added this because TrRabbitBase and TrCTFBase share this as the common ancenstor.
simulated function FlagUpdated(bool bFlagHome)
{
...
defaultproperties
{
   ...
   DefenderTeamIndex=2
   Begin Object Class=CylinderComponent Name=CollisionCylinder Archetype=CylinderComponent'UDKBase.Default__UDKGameObjective:CollisionCylinder'
      CollisionHeight=50.000000
      CollisionRadius=50.000000
      ReplacementPrimitive=None
      Name="CollisionCylinder"
      ObjectArchetype=CylinderComponent'UDKBase.Default__UDKGameObjective:CollisionCylinder'
   End Object
   CylinderComponent=CollisionCylinder
   Begin Object Class=SpriteComponent Name=Sprite Archetype=SpriteComponent'UDKBase.Default__UDKGameObjective:Sprite'
      ...
      Name="Sprite"
      ObjectArchetype=SpriteComponent'UDKBase.Default__UDKGameObjective:Sprite'
   End Object
   Components(0)=Sprite
   Begin Object Class=SpriteComponent Name=Sprite2 Archetype=SpriteComponent'UDKBase.Default__UDKGameObjective:Sprite2'
      ...
      Scale=0.250000
      Name="Sprite2"
      ObjectArchetype=SpriteComponent'UDKBase.Default__UDKGameObjective:Sprite2'
   End Object
   Components(1)=Sprite2
   Begin Object Class=ArrowComponent Name=Arrow Archetype=ArrowComponent'UDKBase.Default__UDKGameObjective:Arrow'
      ArrowColor=(B=255,G=200,R=150,A=255)
      ArrowSize=0.500000
      bTreatAsASprite=True
      ReplacementPrimitive=None
      Name="Arrow"
      ObjectArchetype=ArrowComponent'UDKBase.Default__UDKGameObjective:Arrow'
   End Object
   Components(2)=Arrow
   Components(3)=CollisionCylinder
   Begin Object Class=PathRenderingComponent Name=PathRenderer Archetype=PathRenderingComponent'UDKBase.Default__UDKGameObjective:PathRenderer'
      ReplacementPrimitive=None
      Name="PathRenderer"
      ObjectArchetype=PathRenderingComponent'UDKBase.Default__UDKGameObjective:PathRenderer'
   End Object
   ...
   ObjectArchetype=UDKGameObjective'UDKBase.Default__UDKGameObjective'
}
