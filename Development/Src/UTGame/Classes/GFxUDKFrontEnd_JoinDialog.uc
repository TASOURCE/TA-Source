...
function PopulateServerInfo(OnlineGameSettings GameSettings)
{
    ...
    {         
        ...
        if (SettingId != CONTEXT_ALLOWKEYBOARD && SettingId != CONTEXT_LOCKEDSERVER && 
...
defaultproperties
{
   SubWidgetBindings(2)=(WidgetName="join",WidgetClass=Class'GFxUI.GFxClikWidget')
   SubWidgetBindings(3)=(WidgetName="spectate",WidgetClass=Class'GFxUI.GFxClikWidget')
   SubWidgetBindings(4)=(WidgetName="mutatorinfo_list",WidgetClass=Class'GFxUI.GFxClikWidget')
   SubWidgetBindings(5)=(WidgetName="serverinfo_list",WidgetClass=Class'GFxUI.GFxClikWidget')
   Name="Default__GFxUDKFrontEnd_JoinDialog"
