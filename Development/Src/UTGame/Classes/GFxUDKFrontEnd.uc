...
defaultproperties
{
   ViewData(0)=(ViewName="MainMenu",SWFName="udk_main_menu.swf",DependantViews=("InstantAction","Multiplayer","InfoDialog"))
   ViewData(1)=(ViewName="Multiplayer",SWFName="udk_multiplayer.swf",DependantViews=("JoinGame","HostGame"))
   ViewData(2)=(ViewName="HostGame",SWFName="udk_instant_action.swf",DependantViews=("GameMode","MapSelect","Mutators","Settings","ServerSettings"))
   ViewData(3)=(ViewName="InstantAction",SWFName="udk_instant_action.swf",DependantViews=("GameMode","MapSelect","Mutators","Settings"))
   ViewData(4)=(ViewName="GameMode",SWFName="udk_game_mode.swf")
   ViewData(5)=(ViewName="MapSelect",SWFName="udk_map.swf")
   ViewData(6)=(ViewName="Mutators",SWFName="udk_mutators.swf")
   ViewData(7)=(ViewName="Settings",SWFName="udk_settings.swf")
   ViewData(8)=(ViewName="ServerSettings",SWFName="udk_settings.swf")
   ViewData(9)=(ViewName="InfoDialog",SWFName="udk_dialog_exit.swf")
   ViewData(10)=(ViewName="JoinGame",SWFName="udk_server_browser.swf",DependantViews=("FilterDialog","JoinDialog","ErrorDialog"))
   ViewData(11)=(ViewName="FilterDialog",SWFName="udk_dialog_filter.swf")
   ViewData(12)=(ViewName="JoinDialog",SWFName="udk_dialog_join.swf")
   ViewData(13)=(ViewName="PasswordDialog",SWFName="udk_dialog_password.swf")
   ViewData(14)=(ViewName="ErrorDialog",SWFName="udk_dialog_error.swf")
   bPauseGameWhileActive=True
   bCaptureInput=True
   TimingMode=TM_Real
   WidgetBindings(0)=(WidgetName="MainMenu",WidgetClass=Class'UTGame.GFxUDKFrontEnd_MainMenu')
   WidgetBindings(1)=(WidgetName="InstantAction",WidgetClass=Class'UTGame.GFxUDKFrontEnd_InstantAction')
   WidgetBindings(2)=(WidgetName="MapSelect",WidgetClass=Class'UTGame.GFxUDKFrontEnd_MapSelect')
   WidgetBindings(3)=(WidgetName="GameMode",WidgetClass=Class'UTGame.GFxUDKFrontEnd_GameMode')
   WidgetBindings(4)=(WidgetName="Settings",WidgetClass=Class'UTGame.GFxUDKFrontEnd_Settings')
   WidgetBindings(5)=(WidgetName="Mutators",WidgetClass=Class'UTGame.GFxUDKFrontEnd_Mutators')
   WidgetBindings(6)=(WidgetName="Multiplayer",WidgetClass=Class'UTGame.GFxUDKFrontEnd_Multiplayer')
   WidgetBindings(7)=(WidgetName="HostGame",WidgetClass=Class'UTGame.GFxUDKFrontEnd_HostGame')
   WidgetBindings(8)=(WidgetName="JoinGame",WidgetClass=Class'UTGame.GFxUDKFrontEnd_JoinGame')
   WidgetBindings(9)=(WidgetName="ServerSettings",WidgetClass=Class'UTGame.GFxUDKFrontEnd_ServerSettings')
   WidgetBindings(10)=(WidgetName="InfoDialog",WidgetClass=Class'UTGame.GFxUDKFrontEnd_InfoDialog')
   WidgetBindings(11)=(WidgetName="ErrorDialog",WidgetClass=Class'UTGame.GFxUDKFrontEnd_ErrorDialog')
   WidgetBindings(12)=(WidgetName="JoinDialog",WidgetClass=Class'UTGame.GFxUDKFrontEnd_JoinDialog')
   WidgetBindings(13)=(WidgetName="FilterDialog",WidgetClass=Class'UTGame.GFxUDKFrontEnd_FilterDialog')
   WidgetBindings(14)=(WidgetName="PasswordDialog",WidgetClass=Class'UTGame.GFxUDKFrontEnd_PasswordDialog')
   Name="Default__GFxUDKFrontEnd"
