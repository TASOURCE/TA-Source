...
defaultproperties
{
   ListOptions(0)=(OptionName="JoinGame",OptionLabel="JOIN GAME",OptionDesc="Find opponents online ready for battle.")
   ListOptions(1)=(OptionName="HostGame",OptionLabel="HOST GAME",OptionDesc="Host a custom game. Gain the advantage.")
   ViewTitle="MULTIPLAYER"
   Name="Default__GFxUDKFrontEnd_Multiplayer"
