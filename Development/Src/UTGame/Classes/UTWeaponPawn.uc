...
class UTWeaponPawn extends UDKWeaponPawn
	notplaceable
	native; //$$BE: Added native flag so TrWeaponPawn can compile as native.
...
{
   MySeatIndex=-1
   Begin Object Class=RB_StayUprightSetup Name=MyStayUprightSetup Archetype=RB_StayUprightSetup'UDKBase.Default__UDKWeaponPawn:MyStayUprightSetup'
      Name="MyStayUprightSetup"
      ObjectArchetype=RB_StayUprightSetup'UDKBase.Default__UDKWeaponPawn:MyStayUprightSetup'
   End Object
   StayUprightConstraintSetup=RB_StayUprightSetup'UTGame.Default__UTWeaponPawn:MyStayUprightSetup'
   Begin Object Class=RB_ConstraintInstance Name=MyStayUprightConstraintInstance Archetype=RB_ConstraintInstance'UDKBase.Default__UDKWeaponPawn:MyStayUprightConstraintInstance'
      Name="MyStayUprightConstraintInstance"
      ObjectArchetype=RB_ConstraintInstance'UDKBase.Default__UDKWeaponPawn:MyStayUprightConstraintInstance'
   End Object
   ...
   Begin Object Class=SkeletalMeshComponent Name=SVehicleMesh Archetype=SkeletalMeshComponent'UDKBase.Default__UDKWeaponPawn:SVehicleMesh'
      ...
      Name="SVehicleMesh"
      ObjectArchetype=SkeletalMeshComponent'UDKBase.Default__UDKWeaponPawn:SVehicleMesh'
   End Object
   Mesh=SVehicleMesh
   Begin Object Class=CylinderComponent Name=CollisionCylinder Archetype=CylinderComponent'UDKBase.Default__UDKWeaponPawn:CollisionCylinder'
      ...
      ObjectArchetype=CylinderComponent'UDKBase.Default__UDKWeaponPawn:CollisionCylinder'
   End Object
   ...
   ObjectArchetype=UDKWeaponPawn'UDKBase.Default__UDKWeaponPawn'
}
