...
defaultproperties
{
   TeamNum=255
   bBlockable=True
   Begin Object Class=CylinderComponent Name=CollisionCylinder Archetype=CylinderComponent'UDKBase.Default__UDKVehicleFactory:CollisionCylinder'
      CollisionHeight=50.000000
      CollisionRadius=50.000000
      ReplacementPrimitive=None
      Name="CollisionCylinder"
      ObjectArchetype=CylinderComponent'UDKBase.Default__UDKVehicleFactory:CollisionCylinder'
   End Object
   CylinderComponent=CollisionCylinder
   Begin Object Class=SpriteComponent Name=Sprite Archetype=SpriteComponent'UDKBase.Default__UDKVehicleFactory:Sprite'
      ...
      Name="Sprite"
      ObjectArchetype=SpriteComponent'UDKBase.Default__UDKVehicleFactory:Sprite'
   End Object
   Components(0)=Sprite
   Begin Object Class=ArrowComponent Name=Arrow Archetype=ArrowComponent'UDKBase.Default__UDKVehicleFactory:Arrow'
      ArrowColor=(B=255,G=200,R=150,A=255)
      ArrowSize=0.500000
      bTreatAsASprite=True
      ReplacementPrimitive=None
      Name="Arrow"
      ObjectArchetype=ArrowComponent'UDKBase.Default__UDKVehicleFactory:Arrow'
   End Object
   Components(1)=Arrow
   Components(2)=CollisionCylinder
   Begin Object Class=PathRenderingComponent Name=PathRenderer Archetype=PathRenderingComponent'UDKBase.Default__UDKVehicleFactory:PathRenderer'
      ReplacementPrimitive=None
      Name="PathRenderer"
      ObjectArchetype=PathRenderingComponent'UDKBase.Default__UDKVehicleFactory:PathRenderer'
   End Object
   ...
   End Object
   Components(4)=MyLightEnvironment
   ...
   ObjectArchetype=UDKVehicleFactory'UDKBase.Default__UDKVehicleFactory'
}
