...
defaultproperties
{
   ListOptions(0)=(OptionName="InstantAction",OptionLabel="INSTANT ACTION",OptionDesc="Jump right into the action with some bots.")
   ListOptions(1)=(OptionName="Multiplayer",OptionLabel="MULTIPLAYER",OptionDesc="Host or join a multiplayer game.")
   ListOptions(2)=(OptionName="Exit",OptionLabel="EXIT",OptionDesc="Exit to the desktop.")
   ViewTitle="MAIN MENU"
   CancelButtonHelpText="EXIT GAME"
   Name="Default__GFxUDKFrontEnd_MainMenu"
