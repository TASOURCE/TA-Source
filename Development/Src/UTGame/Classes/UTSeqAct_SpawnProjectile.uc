...
defaultproperties
{
   ...
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Vector',LinkDesc="Target Location",MaxVars=1)
   VariableLinks(2)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Instigator",MinVars=0,MaxVars=1)
