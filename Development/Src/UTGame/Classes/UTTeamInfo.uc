...
//$$ML: I guess we should have made a TrTeamInfo!
simulated event ReplicatedEvent(name VarName)
{
	local UTPlayerController UTPC;

	UTPC = UTPlayerController(GetALocalPlayerController());
	if (VarName == 'Score')
	{
		UTPC.OnScoreChanged(self);
	}
...
defaultproperties
{
   ...
   TeamColorNames(0)="BLOOD EAGLE"
   TeamColorNames(1)="DIAMOND SWORD"
