...
exec function SummonV( string ClassName )
{
	...
	;
	NewClass = class<actor>( DynamicLoadObject( "TribesGame.TrVehicle_"$ClassName, class'Class' ) );
	if ( NewClass == None )
	{
		NewClass = class<actor>( DynamicLoadObject( "TribesGame.TrVehicle_"$ClassName$"_Content", class'Class' ) );
	}
	if( NewClass!=None )
	{
		if ( Pawn != None )
...
exec function AllWeapons()
{
	...
	GiveWeapon("TribesGame.TrDevice_ChainGun");
	GiveWeapon("TribesGame.TrDevice_Jetpack");
	GiveWeapon("TribesGame.TrDevice_Spinfusor");
	GiveWeapon("TribesGame.TrDevice_Melee");
	
	GiveWeapon("TribesGame.TrDevice_SniperRifle");	
	GiveWeapon("TribesGame.TrDevice_Shotgun");	
	GiveWeapon("TribesGame.TrDevice_SaberLanucher");	
	GiveWeapon("TribesGame.TrDevice_RhinoSMG");	
	GiveWeapon("TribesGame.TrDevice_NovaColt");	
	GiveWeapon("TribesGame.TrDevice_Lacerator");	
	GiveWeapon("TribesGame.TrDevice_GrenadeLauncher");	
	GiveWeapon("TribesGame.TrDevice_Eagle");	
	GiveWeapon("TribesGame.TrDevice_dualRhinos");	
	GiveWeapon("TribesGame.TrDevice_AssaultRifle");	
	GiveWeapon("TribesGame.TrDevice_ArxBuster");	
	GiveWeapon("TribesGame.TrDevice_LaserTargeter");
}
