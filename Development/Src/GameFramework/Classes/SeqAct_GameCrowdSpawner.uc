...
defaultproperties
{
   ...
   SpawnRate=10.000000
   SpawnNum=100
   SpawnRadius=200.000000
   SplitScreenNumReduction=0.500000
   AgentLightingChannel=(bInitialized=True,Crowd=True)
   AgentWarmupTime=5.000000
   InputLinks(0)=(LinkDesc="Start")
   InputLinks(1)=(LinkDesc="Stop")
   InputLinks(2)=(LinkDesc="Destroy All")
   OutputLinks(0)=(LinkDesc="Agent Spawned")
   VariableLinks(0)=(LinkDesc="Spawn Points",PropertyName="SpawnPoints")
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Spawned Agent",bWriteable=True)
