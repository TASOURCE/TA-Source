...
struct native UTTakeHitInfo
{
	...
	var name HitBone;
	//$$BE
	/** whether we damaged ourself */
	var bool m_bDamagedSelf;
};
...
replication
{
	...
	if (bNetDirty && !bNetOwner)
		//DrivenWeaponPawn, bPuttingDownWeapon; //$$ML.
		bPuttingDownWeapon;
...
defaultproperties
{
   ...
   MaxSmoothNetUpdateDist=84.000000
   NoSmoothNetUpdateDist=128.000000
   SmoothNetUpdateTime=0.125000
