...
defaultproperties
{
   Begin Object Class=RB_StayUprightSetup Name=MyStayUprightSetup Archetype=RB_StayUprightSetup'Engine.Default__SVehicle:MyStayUprightSetup'
      Name="MyStayUprightSetup"
      ObjectArchetype=RB_StayUprightSetup'Engine.Default__SVehicle:MyStayUprightSetup'
   End Object
   StayUprightConstraintSetup=RB_StayUprightSetup'UDKBase.Default__UDKVehicleBase:MyStayUprightSetup'
   Begin Object Class=RB_ConstraintInstance Name=MyStayUprightConstraintInstance Archetype=RB_ConstraintInstance'Engine.Default__SVehicle:MyStayUprightConstraintInstance'
   ...
   End Object
   StayUprightConstraintInstance=RB_ConstraintInstance'UDKBase.Default__UDKVehicleBase:MyStayUprightConstraintInstance'
   SightRadius=12000.000000
   Begin Object Class=SkeletalMeshComponent Name=SVehicleMesh Archetype=SkeletalMeshComponent'Engine.Default__SVehicle:SVehicleMesh'
   ...
   End Object
   Mesh=SVehicleMesh
   Begin Object Class=CylinderComponent Name=CollisionCylinder Archetype=CylinderComponent'Engine.Default__SVehicle:CollisionCylinder'
