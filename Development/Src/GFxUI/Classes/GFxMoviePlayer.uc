...
/** //$$ JCR - Force Flash to interpolate animations much, much better
 */
var bool bForceSmoothAnimation;
...
/** //$$ JCR - Update from changing a setting on the fly
 */
native function SetForceSmoothAnimation(bool bEnable);
