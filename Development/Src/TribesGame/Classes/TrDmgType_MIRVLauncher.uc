class TrDmgType_MIRVLauncher extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_MIRVLauncher'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_MIRVLauncher:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_MIRVLauncher:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_MIRVLauncher"
