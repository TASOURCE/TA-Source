 ...
 * 
 */
class TrProj_Falcon extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_Falcon:MyLightEnvironment'
   ...
   bWideCheck=True
   CheckRadius=60.000000
   CustomGravityScaling=0.000000
   Speed=21000.000000
   MaxSpeed=21000.000000
   Damage=65.000000
   MyDamageType=Class'TribesGame.TrDmgType_Falcon'
