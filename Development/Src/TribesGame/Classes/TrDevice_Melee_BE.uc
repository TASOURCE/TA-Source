class TrDevice_Melee_BE extends TrDevice_Melee;

defaultproperties
{
   m_TinyWeaponsOffset=(X=0.000000,Y=0.000000,Z=0.000000)
   AttachmentClass=Class'TribesGame.TrAttachment_Melee_BE'
   PlayerViewOffset=(X=15.000000,Y=0.000000,Z=-10.000000)
   ...
   Name="Default__TrDevice_Melee_BE"
