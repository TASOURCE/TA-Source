 ...
 * 
 */
class TrProj_RhinoSMG extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_RhinoSMG:MyLightEnvironment'
   ...
   Damage=70.000000
   MyDamageType=Class'TribesGame.TrDmgType_RhinoSMG'
