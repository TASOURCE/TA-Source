/**
 * TrDeployable_WallTurret
 */
class TrDeployable_WallTurret extends TrDeployable_Turret;
...
defaultproperties
{
   ...
   m_DeviceClass=Class'TribesGame.TrSubDevice_WallTurret'
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeployable_Turret:ObjectiveMesh'
      ...
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrDeployable_WallTurret:MyLightEnvironment'
   ...
   Name="Default__TrDeployable_WallTurret"
