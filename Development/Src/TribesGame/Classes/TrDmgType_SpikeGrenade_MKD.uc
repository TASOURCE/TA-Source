class TrDmgType_SpikeGrenade_MKD extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   m_fDamageMultiplierAgainstGenerators=0.010000
   m_bCausesGib=True
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_SpikeGrenade_MKD'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_SpikeGrenade_MKD:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_SpikeGrenade_MKD:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_SpikeGrenade_MKD"
