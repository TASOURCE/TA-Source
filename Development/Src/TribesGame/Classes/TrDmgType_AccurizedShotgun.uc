class TrDmgType_AccurizedShotgun extends TrDmgType_Bullet
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_AccurizedShotgun'
   NodeDamageScaling=0.800000
   CustomTauntIndex=4
   VehicleDamageScaling=0.700000
   VehicleMomentumScaling=2.000000
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_AccurizedShotgun:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_AccurizedShotgun:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_AccurizedShotgun"
