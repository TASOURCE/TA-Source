 ...
 * 
 */
class TrProj_StealthSpinfusor extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_StealthSpinfusor:MyLightEnvironment'
   ...
   Begin Object Class=PointLightComponent Name=ProjectilePointLight Archetype=PointLightComponent'TribesGame.Default__TrProjectile:ProjectilePointLight'
      ...
      LightColor=(B=0,G=150,R=255,A=255)
      CastShadows=False
      Name="ProjectilePointLight"
      ObjectArchetype=PointLightComponent'TribesGame.Default__TrProjectile:ProjectilePointLight'
   End Object
   ProjectileLight=ProjectilePointLight
   ExplosionLightClass=Class'TribesGame.TrExplosionLight_StealthSpinfusor'
   bWideCheck=True
   ...
   MyDamageType=Class'TribesGame.TrDmgType_StealthSpinfusor'
   ...
   Name="Default__TrProj_StealthSpinfusor"
