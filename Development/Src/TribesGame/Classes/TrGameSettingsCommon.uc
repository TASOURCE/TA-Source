...
class TrGameSettingsCommon extends UTGameSettingsCommon;

var databinding bool    Console;
var String              GameMode;
var String              MapName;
...
const ITEM_VOICE_T2BDERM03                              = 8726;#linenumber 9

defaultproperties
{
   MaxPlayers=64
   NumPublicConnections=64
   LocalizedSettings(0)=(Id=32779,AdvertisementType=ODAT_OnlineService)
   LocalizedSettings(1)=(AdvertisementType=ODAT_OnlineService)
   LocalizedSettings(2)=(Id=1,AdvertisementType=ODAT_OnlineService)
   LocalizedSettings(3)=(Id=2,AdvertisementType=ODAT_OnlineService)
   Properties(0)=(PropertyId=268435466,Data=(Type=SDT_Int32,Value1=20),AdvertisementType=ODAT_OnlineService)
   Properties(1)=(PropertyId=268435467,Data=(Type=SDT_Int32,Value1=20),AdvertisementType=ODAT_OnlineService)
   Properties(2)=(PropertyId=1073741825,Data=(Type=SDT_String),AdvertisementType=ODAT_QoS)
   Properties(3)=(PropertyId=1073741826,Data=(Type=SDT_String),AdvertisementType=ODAT_QoS)
   LocalizedSettingsMappings(0)=(Id=32779,Name="GameMode",ValueMappings=(,(Id=1),(Id=2)))
   LocalizedSettingsMappings(1)=(Name="MapName",ValueMappings=())
   LocalizedSettingsMappings(2)=(Id=1,Name="LockedServer",ValueMappings=(,(Id=1)))
   LocalizedSettingsMappings(3)=(Id=2,Name="AllowKeyboard",ValueMappings=(,(Id=1)))
   PropertyMappings(0)=(Id=268435466,Name="TimeLimit",MappingType=PVMT_PredefinedValues,PredefinedValues=((Type=SDT_Int32),(Type=SDT_Int32,Value1=5),(Type=SDT_Int32,Value1=10),(Type=SDT_Int32,Value1=15),(Type=SDT_Int32,Value1=20),(Type=SDT_Int32,Value1=30),(Type=SDT_Int32,Value1=45),(Type=SDT_Int32,Value1=60)))
   PropertyMappings(1)=(Id=268435467,Name="GoalScore",MappingType=PVMT_PredefinedValues,PredefinedValues=((Type=SDT_Int32),(Type=SDT_Int32,Value1=5),(Type=SDT_Int32,Value1=10),(Type=SDT_Int32,Value1=15),(Type=SDT_Int32,Value1=20),(Type=SDT_Int32,Value1=25),(Type=SDT_Int32,Value1=30),(Type=SDT_Int32,Value1=35),(Type=SDT_Int32,Value1=40),(Type=SDT_Int32,Value1=45),(Type=SDT_Int32,Value1=50),(Type=SDT_Int32,Value1=55),(Type=SDT_Int32,Value1=60)))
   PropertyMappings(2)=(Id=1073741825,Name="CustomMapName")
   PropertyMappings(3)=(Id=1073741826,Name="CustomGameMode")
   Name="Default__TrGameSettingsCommon"
