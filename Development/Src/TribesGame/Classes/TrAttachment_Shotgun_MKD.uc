 ...
 * 
 */
class TrAttachment_Shotgun_MKD extends TrDeviceAttachment;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_Shotgun_MKD:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_Shotgun_MKD'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_Shotgun_MKD"
