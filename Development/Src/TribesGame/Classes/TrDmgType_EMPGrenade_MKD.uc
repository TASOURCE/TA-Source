class TrDmgType_EMPGrenade_MKD extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_EMPGrenade_MKD'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_EMPGrenade_MKD:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_EMPGrenade_MKD:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_EMPGrenade_MKD"
