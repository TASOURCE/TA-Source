class TrDmgType_BoltLauncher extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_BoltLauncher'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_BoltLauncher:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_BoltLauncher:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_BoltLauncher"
