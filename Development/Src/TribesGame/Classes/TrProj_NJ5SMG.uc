 ...
 * 
 */
class TrProj_NJ5SMG extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_NJ5SMG:MyLightEnvironment'
   ...
   Damage=140.000000
   MyDamageType=Class'TribesGame.TrDmgType_NJ5SMG'
