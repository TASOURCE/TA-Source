 ...
 * 
 */
class TrAttachment_AccurizedShotgun extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LightMed_Shotgun"
   m_nmHeavyAimProfileName="Heavy_Shotgun"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_AccurizedShotgun:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_AccurizedShotgun'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_AccurizedShotgun"
