 ...
 * 
 */
class TrDevice_MIRVGrenade extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   InfoPanelDescription="The cluster grenade breaks apart into several smaller bomblets on detonation, each exploding for additional damage."
   InfoPanelDamage=10
   InfoPanelRadius=6
   InfoPanelFireRate=5
   InfoPanelClipSize=-1
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=8283,Modifications=((ModType=29,Value=1.000000)))
   Upgrades(1)=(IconId=7,DatabaseItemId=8284,Modifications=((ModType=55,Value=0.100000)))
   Upgrades(2)=(IconId=5,DatabaseItemId=8285,Modifications=((ModType=68,Value=0.200000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_MIRVGrenade_Content"
   ShotCost(0)=1
   ShotCost(1)=()
   AttachmentClass=Class'TribesGame.TrAttachment_MIRVGrenade'
   SmallWeaponsOffset=(X=0.000000,Y=0.000000,Z=-1.500000)
   WideScreenOffsetScaling=1.000000
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_MIRVGrenade'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_MIRVGrenade"
