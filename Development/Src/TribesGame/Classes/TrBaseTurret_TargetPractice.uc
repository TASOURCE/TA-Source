class TrBaseTurret_TargetPractice extends TrDeployable_BaseTurret
    placeable;
...
simulated state BlownUp
{
    ...
    {
		// Regen after an amount of time.
		SetTimer(5.0, false, 'RegenTimer');
	...
	function RegenTimer()
	{
		...
		DoRepairs(default.r_Health * -1.0, none, none, none, H);
	}
}
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeployable_BaseTurret:ObjectiveMesh'
      ...
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrBaseTurret_TargetPractice:MyLightEnvironment'
   ...
   m_sScreenName="Target Practice Turret"
   ...
   Name="Default__TrBaseTurret_TargetPractice"
