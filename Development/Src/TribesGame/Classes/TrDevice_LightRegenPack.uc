 ...
 *
 */
class TrDevice_LightRegenPack extends TrDevice_Pack;

defaultproperties
{
   DBWeaponId=7828
   m_EffectInfo(0)=(effectClass=Class'TribesGame.TrEffect_LightRegenBuff',Type=ET_Equip)
   m_nIconIndex=13
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_LightRegenPack:FireCameraShake'
   ...
   Name="Default__TrDevice_LightRegenPack"
