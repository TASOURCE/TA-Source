class TrDmgType_HeavyBoltLauncher extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_HeavyBoltLauncher'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_HeavyBoltLauncher:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_HeavyBoltLauncher:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_HeavyBoltLauncher"
