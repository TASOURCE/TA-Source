 ...
 * 
 */
class TrProj_HERCPilot extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_HERCPilot:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_HERCPilot'
   ...
   Name="Default__TrProj_HERCPilot"
