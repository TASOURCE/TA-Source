class TrDmgType_GrenadeLauncher extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_GrenadeLauncher'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_GrenadeLauncher:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_GrenadeLauncher:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_GrenadeLauncher"
