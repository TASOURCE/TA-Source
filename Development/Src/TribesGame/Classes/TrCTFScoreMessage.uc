class TrCTFScoreMessage extends UTLocalMessage;
...
var(Message) localized string Team0Scored;
var(Message) localized string Team1Scored;
var(Message) localized string Team0LeadingBy2;
var(Message) localized string Team1LeadingBy2;
var(Message) localized string Team0JustGotAhead;
var(Message) localized string Team1JustGotAhead;
var(Message) localized string PlayerHattrick;
var(Message) localized string TeamHigherScore;
	...
	)
{
	...
	//ML: Removed message strings since TrCTFMessage handles scoring messages.
	switch (Switch)
	{
		// team 0 scored
	case 0:
		//messageString = Default.Team0Scored;
		UTPlayerController(P).ClientMusicEvent(13);
		break;

		// team 1 scored
	case 1:
		//messageString = Default.Team1Scored;
		UTPlayerController(P).ClientMusicEvent(13);
		break;

		// team 0 ahead by 2
	case 2:
		//messageString = Default.Team0LeadingBy2;
		UTPlayerController(P).ClientMusicEvent(14);
		break;

		// team 1 ahead by 2
	case 3:
		//messageString = Default.Team1LeadingBy2;
		UTPlayerController(P).ClientMusicEvent(14);
		break;

		// team 0 just got ahead
	case 4:
		//messageString = Default.Team0JustGotAhead;
		UTPlayerController(P).ClientMusicEvent(15);
		break;

		// team 1 just got ahead
	case 5:
		//messageString = Default.Team1JustGotAhead;
		UTPlayerController(P).ClientMusicEvent(15);
		break;
	...
	case 6:
		...
		{
			//messageString = RelatedPRI_1.PlayerName@messageString@Default.PlayerHattrick;
		}
		break;

		// team scored
	case 7:
		//messageString = Default.TeamHigherScore;
		break;
	}

	//HUD.AddUpdateToCombatLog(messageString, -1,-1,"");
}
...
defaultproperties
{
   ...
   FontSize=2
   Name="Default__TrCTFScoreMessage"
