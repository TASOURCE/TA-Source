 ...
 * 
 */
class TrAttachment_HeavyBoltLauncher extends TrDeviceAttachment;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_HeavyBoltLauncher:SkeletalMeshComponent0.MeshSequenceA'
      AnimSets(0)=None
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_HeavyBoltLauncher'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_HeavyBoltLauncher"
