 ...
 * 
 */
class TrProj_BaseTurret extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_BaseTurret:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_BaseTurret'
   ...
   Name="Default__TrProj_BaseTurret"
