class TrDmgType_TrackingMissile_MKD extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_SaberLauncher_MKD'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_TrackingMissile_MKD:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_TrackingMissile_MKD:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_TrackingMissile_MKD"
