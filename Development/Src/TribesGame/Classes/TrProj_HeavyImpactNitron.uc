 ...
 * 
 */
class TrProj_HeavyImpactNitron extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_HeavyImpactNitron:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_HeavyImpactNitron'
   ...
   Name="Default__TrProj_HeavyImpactNitron"
