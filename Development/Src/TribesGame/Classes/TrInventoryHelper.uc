class TrInventoryHelper extends Object;
...
function class<TrDevice> GetEquipClass(int DeviceId)
{
    switch (DeviceId)
    {
    case WEAPON_ID_ARX_BUSTER:
        return class'TrDevice_ArxBuster';
    case WEAPON_ID_CHAINGUN:
        return class'TrDevice_Chaingun';
    case WEAPON_ID_DROPJAMMER:
        return class'TrDevice_DropJammerDeployable';
    case WEAPON_ID_FORCEFIELD:
        return class'TrDevice_ForceFieldDeployable';
    case WEAPON_ID_FORCEFIELD_PERSONAL:
        return class'TrDevice_PersonalForceFieldDeployable';
    case WEAPON_ID_GRENADE:
        return class'TrDevice_Grenade';
    case WEAPON_ID_GRENADE_AP:
        return class'TrDevice_APGrenade';
    case WEAPON_ID_GRENADE_AP_HEAVY:
        return class'TrDevice_HeavyAPGrenade';
    case WEAPON_ID_GRENADE_EMP:
        return class'TrDevice_EMPGrenade';
    case WEAPON_ID_GRENADE_FLARE:
        return class'TrDevice_FlareGrenade';
    case WEAPON_ID_GRENADE_NITRON:
        return class'TrDevice_ConcussionGrenade';
    case WEAPON_ID_GRENADE_NITRON_HEAVY:
        return class'TrDevice_HeavyImpactNitron';
    case WEAPON_ID_GRENADE_SPIKE:
        return class'TrDevice_SpikeGrenade';
    case WEAPON_ID_GRENADE_ST:
        return class'TrDevice_STGrenade';
    case WEAPON_ID_GRENADE_STICKY:
        return class'TrDevice_StickyGrenade';
    case WEAPON_ID_GRENADE_STICKY_LIGHT:
        return class'TrDevice_LightStickyGrenade';
    case WEAPON_ID_GRENADE_T5:
        return class'TrDevice_GrenadeT5';
    case WEAPON_ID_GRENADE_WHITEOUT:
        return class'TrDevice_WhiteOut';
    case WEAPON_ID_GRENADE_XL:
        return class'TrDevice_GrenadeXL';
    case WEAPON_ID_LAUNCHER_BOLT:
        return class'TrDevice_BoltLauncher';
    case WEAPON_ID_LAUNCHER_BOLT_HEAVY:
        return class'TrDevice_HeavyBoltLauncher';
    case WEAPON_ID_LAUNCHER_GRENADE:
        return class'TrDevice_GrenadeLauncher';
    case WEAPON_ID_LAUNCHER_MIRV:
        return class'TrDevice_MIRVLauncher';
    case WEAPON_ID_LAUNCHER_MORTAR:
        return class'TrDevice_MortarLauncher';
    case WEAPON_ID_LAUNCHER_SABER:
        return class'TrDevice_SaberLauncher';
    case WEAPON_ID_MELEE:
        return none;//class'TrDevice_Melee';
    case WEAPON_ID_MINE:
        return class'TrDevice_Mine';
    case WEAPON_ID_MINE_CLAYMORE:
        return class'TrDevice_Claymore';
    case WEAPON_ID_MINE_PRISM:
        return class'TrDevice_PrismMineDeployable';
    case WEAPON_ID_MOTIONALARM:
        return class'TrDevice_MotionSensorDeployable';
    case WEAPON_ID_PISTOL_EAGLE:
        return class'TrDevice_Eagle';
    case WEAPON_ID_PISTOL_EAGLE_CUSTOM:
        return class'TrDevice_CustomEagle';
    case WEAPON_ID_PISTOL_NOVA_COLT:
        return class'TrDevice_NovaColt';
    case WEAPON_ID_PISTOL_NOVA_SLUG:
        return class'TrDevice_NovaSlug';
    case WEAPON_ID_PISTOL_FALCON:
        return class'TrDevice_Falcon';
    case WEAPON_ID_PISTOL_H1:
        return class'TrDevice_H1';
    case WEAPON_ID_PISTOL_SN7:
        return class'TrDevice_SN7';
    case WEAPON_ID_PISTOL_SPARROW:
        return class'TrDevice_Sparrow';
    case WEAPON_ID_TURRET_EXR:
        return class'TrDevice_AntiAirTurretDeployable';
    case WEAPON_ID_TURRET_LIGHT:
        return class'TrDevice_LightTurretDeployable';
    case WEAPON_ID_TURRET_WALL:
        return class'TrDevice_WallTurretDeployable';
    case WEAPON_ID_REPAIR_TOOL:
        return class'TrDevice_RepairTool';
    case WEAPON_ID_REPAIR_TOOL_SD:
        return class'TrDevice_RepairToolSD';
    case WEAPON_ID_RIFLE_ASSAULT:
        return class'TrDevice_AssaultRifle';
    case WEAPON_ID_RIFLE_ASSAULT_LIGHT:
        return class'TrDevice_LightAssaultRifle';
    case WEAPON_ID_RIFLE_ASSAULT_S22:
        return class'TrDevice_S22Rifle';
    case WEAPON_ID_RIFLE_ASSAULT_X1:
        return class'TrDevice_X1Rifle';
    case WEAPON_ID_RIFLE_PHASE:
        return class'TrDevice_PhaseRifle';
    case WEAPON_ID_RIFLE_SNIPER:
        return class'TrDevice_SniperRifle';
    case WEAPON_ID_SMG_NJ4:
        return class'TrDevice_NJ4SMG';
    case WEAPON_ID_SMG_RHINO:
        return class'TrDevice_RhinoSMG';
    case WEAPON_ID_SMG_TCN4:
        return class'TrDevice_TCN4SMG';
    case WEAPON_ID_SHOTGUN:
        return class'TrDevice_Shotgun';
    case WEAPON_ID_SHOTGUN_ARX:
        return class'TrDevice_ArxShotgun';
    case WEAPON_ID_SHOTGUN_AUTO:
        return class'TrDevice_AutoShotgun';
    case WEAPON_ID_SHOTGUN_SAWED_OFF:
        return class'TrDevice_SawedOffShotgun';
    case WEAPON_ID_SPINFUSOR:
        return class'TrDevice_Spinfusor';
    case WEAPON_ID_SPINFUSOR_D:
        return class'TrDevice_SpinfusorD';
    case WEAPON_ID_SPINFUSOR_HEAVY:
        return class'TrDevice_HeavySpinfusor';
    case WEAPON_ID_SPINFUSOR_LIGHT:
        return class'TrDevice_LightSpinfusor';
    case WEAPON_ID_SPINFUSOR_TOSS:
        return class'TrDevice_DiskToss';
    case WEAPON_ID_TCNG:
        return class'TrDevice_TCNG';
    case WEAPON_ID_THUMPER:
        return class'TrDevice_Thumper';
    case WEAPON_ID_THUMPER_D:
        return class'TrDevice_ThumperD';
    case WEAPON_ID_STEALTHLIGHTSPINFUSOR:
        return class'TrDevice_StealthLightSpinfusor';
    case WEAPON_ID_PROXIMITY_GRENADE:
        return class'TrDevice_ProximityGrenade';
    case WEAPON_ID_INFILTRATORBLANK:
		return class'TrDevice_ConcussionGrenade_Blank';
	case WEAPON_ID_ACCURIZEDSHOTGUN:
        return class'TrDevice_AccurizedShotgun';
    case WEAPON_ID_MINE_ARMOREDCLAYMORE:
        return class'TrDevice_ArmoredClaymore';
    case WEAPON_ID_BUCKLER:
        return class'TrDevice_Buckler';
    case WEAPON_ID_IMPACTBOMBLETS:
        return class'TrDevice_ImpactBomblets';
    case WEAPON_ID_LR1MORTAR:
        return class'TrDevice_LR1Mortar';
    case WEAPON_ID_MIRV_GRENADE:
        return class'TrDevice_MIRVGrenade';
    case WEAPON_ID_GRENADE_NINJASMOKE:
        return class'TrDevice_NinjaSmoke';
    case WEAPON_ID_NJ5SMG:
        return class'TrDevice_NJ5SMG';
    case WEAPON_ID_PLASMA_CANNON:
        return class'TrDevice_PlasmaCannon';
    case WEAPON_ID_PLASMA_GUN:
        return class'TrDevice_PlasmaGun';
    case WEAPON_ID_REMOTE_ARX_BUSTER:
        return class'TrDevice_RemoteArxBuster';
    case WEAPON_ID_ROCKETLAUNCHER:
        return class'TrDevice_RocketLauncher';
    case WEAPON_ID_SAP20:
        return class'TrDevice_SAP20';
    case WEAPON_ID_THROWINGKNIVES:
        return class'TrDevice_ThrowingKnives';
    case WEAPON_ID_SPIKELAUNCHER:
		return class'TrDevice_SpikeLauncher';
	case WEAPON_ID_TARGETINGBEACON:
		return class'TrDevice_TargetingBeacon';

		// New Variants Added

	case WEAPON_ID_ARX_BUSTER_MKD:
        return class'TrDevice_ArxBuster_MKD';
    case WEAPON_ID_CHAINGUN_MKD:
        return class'TrDevice_ChainGun_MKD';
    case WEAPON_ID_GRENADE_MKD:
        return class'TrDevice_Grenade_MKD';
    case WEAPON_ID_GRENADE_AP_HEAVY_MKD:
		return class'TrDevice_HeavyAPGrenade_MKD';
	case WEAPON_ID_GRENADE_EMP_MKD:
        return class'TrDevice_EMPGrenade_MKD';
    case WEAPON_ID_GRENADE_NITRON_MKD:
        return class'TrDevice_ConcussionGrenade_MKD';
    case WEAPON_ID_GRENADE_SPIKE_MKD:
        return class'TrDevice_SpikeGrenade_MKD';
    case WEAPON_ID_GRENADE_STICKY_MKD:
        return class'TrDevice_StickyGrenade_MKD';
    case WEAPON_ID_GRENADE_XL_MKD:
        return class'TrDevice_GrenadeXL_MKD';
    case WEAPON_ID_LAUNCHER_MORTAR_MKD:
        return class'TrDevice_MortarLauncher_MKD';
    case WEAPON_ID_LAUNCHER_SABER_MKD:
        return class'TrDevice_SaberLauncher_MKD';
    case WEAPON_ID_MINE_CLAYMORE_MKD:
        return class'TrDevice_Claymore_MKD';
    case WEAPON_ID_PISTOL_NOVA_COLT_MKD:
        return class'TrDevice_NovaColt_MKD';
    case WEAPON_ID_PISTOL_SN7_MKD:
        return class'TrDevice_SN7_MKD';
    case WEAPON_ID_REPAIR_TOOL_SD_MKD:
        return class'TrDevice_RepairToolSD_MKD';
    case WEAPON_ID_RIFLE_ASSAULT_MKD:
        return class'TrDevice_AssaultRifle_MKD';
    case WEAPON_ID_RIFLE_SNIPER_MKD:
        return class'TrDevice_SniperRifle_MKD';
    case WEAPON_ID_SMG_NJ4_MKD:
        return class'TrDevice_NJ4SMG_MKD';
    case WEAPON_ID_SMG_RHINO_MKD:
        return class'TrDevice_RhinoSMG_MKD';
    case WEAPON_ID_SMG_TCN4_MKD:
        return class'TrDevice_TCN4SMG_MKD';
    case WEAPON_ID_SHOTGUN_MKD:
		return class'TrDevice_Shotgun_MKD';
	case WEAPON_ID_SHOTGUN_AUTO_MKD:
		return class'TrDevice_AutoShotgun_MKD';
	case WEAPON_ID_SPINFUSOR_D_MKD:
        return class'TrDevice_SpinfusorD_MKD';
    case WEAPON_ID_SPINFUSOR_HEAVY_MKD:
        return class'TrDevice_HeavySpinfusor_MKD';
    case WEAPON_ID_SPINFUSOR_LIGHT_MKD:
        return class'TrDevice_LightSpinfusor_MKD';
    case WEAPON_ID_TCNG_MKD:
		return class'TrDevice_TCNG_MKD';
	case WEAPON_ID_THUMPERD_MKD:
		return class'TrDevice_ThumperD_MKD';

		// Twinfusor Update
	case WEAPON_ID_LIGHTTWINFUSOR:
		return class'TrDevice_LightTwinfusor';
	case WEAPON_ID_TWINFUSOR:
		return class'TrDevice_Twinfusor';
	case WEAPON_ID_HEAVYTWINFUSOR:
		return class'TrDevice_HeavyTwinfusor';
		
		// TCN Update
	case WEAPON_ID_SPINFUSOR_LIGHT_100X:
		return class'TrDevice_LightSpinfusor_100X';
	case WEAPON_ID_REPAIR_DEPLOYABLE:
		return class'TrDevice_RepairDeployable';
	case WEAPON_ID_SPINFUSOR_100X:
		return class'TrDevice_Spinfusor_100X';
	case WEAPON_ID_TC24:
		return class'TrDevice_TC24';
    ...
    case ITEM_PACK_AMMO:
        return class'TrDevice_AmmoPack';
    case ITEM_PACK_BLINK:
        return class'TrDevice_Blink';
    case ITEM_PACK_DAMAGE:
        return class'TrDevice_DamagePack';
    case ITEM_PACK_ENERGY_SOLDIER:
        return class'TrDevice_EnergyPack_Soldier';
    case ITEM_PACK_ENERGY_JUGGERNAUT:
        return class'TrDevice_EnergyPack_Juggernaut';
    case ITEM_PACK_ENERGY_BRUTE:
        return class'TrDevice_EnergyPack_Brute';
    case ITEM_PACK_RECHARGE_PATHFINDER:
        return class'TrDevice_ERechargePack_Pathfinder';
    case ITEM_PACK_RECHARGE_SENTINEL:
        return class'TrDevice_ERechargePack_Sentinel';
    case ITEM_PACK_HEAVYSHIELD:
        return class'TrDevice_HeavyShieldPack';
    case ITEM_PACK_JAMMER:
        return class'TrDevice_JammerPack';
    case ITEM_PACK_LIGHTREGEN:
        return class'TrDevice_LightRegenPack';
    case ITEM_PACK_POWERPOOL:
        return class'TrDevice_MaxPowerPoolPack';
    case ITEM_PACK_MINORENERGY:
        return class'TrDevice_MinorEnergyPack';
    case ITEM_PACK_REGEN:
        return class'TrDevice_RegenPack';
    case ITEM_PACK_SHIELD:
        return class'TrDevice_ShieldPack';
    case ITEM_PACK_STEALTH:
        return class'TrDevice_Stealth';
    case ITEM_PACK_UTILITY_SOLDIER:
        return class'TrDevice_UtilityPack_Soldier';
    case ITEM_PACK_HIGHSPEEDSTEALTH:
        return class'TrDevice_HighSpeedStealth';
    case ITEM_PACK_SURVIVAL:
        return class'TrDevice_SurvivalPack';
        
        // Perks

    case ITEM_PERK_BOUNTYHUNTER:
        return class'TrPerk_BountyHunter';
    case ITEM_PERK_CLOSECOMBAT:
        return class'TrPerk_CloseCombat';
    case ITEM_PERK_DETERMINATION:
        return class'TrPerk_Determination';
    case ITEM_PERK_EGOCENTRIC:
        return class'TrPerk_Egocentric';
    case ITEM_PERK_LOOTER:
        return class'TrPerk_Looter';
    case ITEM_PERK_MECHANIC:
        return class'TrPerk_Mechanic';
    case ITEM_PERK_PILOT:
        return class'TrPerk_Pilot';
    case ITEM_PERK_POTENTIALENERGY:
        return class'TrPerk_PotentialEnergy';
    case ITEM_PERK_QUICKDRAW:
        return class'TrPerk_QuickDraw';
    case ITEM_PERK_REACH:
        return class'TrPerk_Reach';
    case ITEM_PERK_SAFEFALL:
        return class'TrPerk_SafeFall';
    case ITEM_PERK_SAFETYTHIRD:
        return class'TrPerk_SafetyThird';
    case ITEM_PERK_STEALTHY:
        return class'TrPerk_Stealthy';
    case ITEM_PERK_SUPERCAPACITOR:
        return class'TrPerk_SuperCapacitor';
    case ITEM_PERK_SUPERHEAVY:
        return class'TrPerk_SuperHeavy';
    case ITEM_PERK_SURVIVALIST:
        return class'TrPerk_Survivalist';
    case ITEM_PERK_ULTRACAPACITOR:
        return class'TrPerk_UltraCapacitor';
    case ITEM_PERK_WHEELDEAL:
        return class'TrPerk_WheelDeal';
    case ITEM_PERK_RAGE:
        return class'TrPerk_Rage';
    case ITEM_PERK_SONICPUNCH:
        return class'TrPerk_SonicPunch';
    case ITEM_PERK_LIGHTWEIGHT:
        return class'TrPerk_Lightweight';

        // Armor Mods

    case ITEM_ARMOR_MOD_BRUTE_1:
        return class'TrArmorMod_Brute';
    case ITEM_ARMOR_MOD_DOOMBRINGER_1:
        return class'TrArmorMod_Doombringer';
    case ITEM_ARMOR_MOD_INFILTRATOR_1:
        return class'TrArmorMod_Infiltrator';
    case ITEM_ARMOR_MOD_JUGGERNAUT_1:
        return class'TrArmorMod_Juggernaut';
    case ITEM_ARMOR_MOD_PATHFINDER_1:
        return class'TrArmorMod_Pathfinder';
    case ITEM_ARMOR_MOD_RAIDER_1:
        return class'TrArmorMod_Raider';
    case ITEM_ARMOR_MOD_SENTINEL_1:
        return class'TrArmorMod_Sentinel';
    case ITEM_ARMOR_MOD_SOLDIER_1:
        return class'TrArmorMod_Soldier';
    case ITEM_ARMOR_MOD_TECHNICIAN_1:
        return class'TrArmorMod_Technician';

        // Voices
        
    case ITEM_VOICE_LIGHT:
        return class'TrPlayerVoice_Light';
    case ITEM_VOICE_MEDIUM:
        return class'TrPlayerVoice_Medium';
    case ITEM_VOICE_HEAVY:
        return class'TrPlayerVoice_Heavy';
    case ITEM_VOICE_DARK:
        return class'TrPlayerVoice_Dark';
    case ITEM_VOICE_FEM1:
        return class'TrPlayerVoice_Fem1';
    case ITEM_VOICE_FEM2:
        return class'TrPlayerVoice_Fem2';
    case ITEM_VOICE_AUS:
        return class'TrPlayerVoice_Aus';
	case ITEM_VOICE_T2FEM01:
        return class'TrPlayerVoice_T2_Fem01';
	case ITEM_VOICE_T2FEM02:
        return class'TrPlayerVoice_T2_Fem02';
	case ITEM_VOICE_T2FEM03:
        return class'TrPlayerVoice_T2_Fem03';
	case ITEM_VOICE_T2FEM04:
        return class'TrPlayerVoice_T2_Fem04';
	case ITEM_VOICE_T2FEM05:
        return class'TrPlayerVoice_T2_Fem05';
	case ITEM_VOICE_T2MALE01:
        return class'TrPlayerVoice_T2_Male01';
	case ITEM_VOICE_T2MALE02:
        return class'TrPlayerVoice_T2_Male02';
	case ITEM_VOICE_T2MALE03:
        return class'TrPlayerVoice_T2_Male03';
	case ITEM_VOICE_T2MALE04:
        return class'TrPlayerVoice_T2_Male04';
	case ITEM_VOICE_T2MALE05:
        return class'TrPlayerVoice_T2_Male05';
	case ITEM_VOICE_T2BDERM01:
        return class'TrPlayerVoice_T2_BioDerm01';
	case ITEM_VOICE_T2BDERM02:
        return class'TrPlayerVoice_T2_BioDerm02';
	case ITEM_VOICE_T2BDERM03:
        return class'TrPlayerVoice_T2_BioDerm03';
...
function class<TrSkin> GetSkinClass(int SkinId)
{
    switch (SkinId)
    {
    case ITEM_SKIN_PATHFINDER:
        return class'TrSkin_Pathfinder';
    case ITEM_SKIN_PATHFINDER_MERC:
        return class'TrSkin_Pathfinder_Merc';
    case ITEM_SKIN_INFILTRATOR:
        return class'TrSkin_Infiltrator';
    case ITEM_SKIN_INFILTRATOR_ASSASSIN:
        return class'TrSkin_Infiltrator_Assassin';
    case ITEM_SKIN_INFILTRATOR_MERC:
        return class'TrSkin_Infiltrator_Merc';
    case ITEM_SKIN_SENTINEL:
        return class'TrSkin_Sentinel';
    case ITEM_SKIN_SENTINEL_MERC:
        return class'TrSkin_Sentinel_Merc';
    case ITEM_SKIN_SOLDIER:
        return class'TrSkin_Soldier';
    case ITEM_SKIN_TECHNICIAN:
        return class'TrSkin_Technician';
    case ITEM_SKIN_TECHNICIAN_MERC:
        return class'TrSkin_Technician_Merc';
    case ITEM_SKIN_RAIDER:
        return class'TrSkin_Raider';
    case ITEM_SKIN_RAIDER_GRIEVER:
        return class'TrSkin_Raider_Griever';
    case ITEM_SKIN_RAIDER_MERC:
        return class'TrSkin_Raider_Merc';
    case ITEM_SKIN_JUGGERNAUT:
        return class'TrSkin_Juggernaut';
    case ITEM_SKIN_DOOMBRINGER:
        return class'TrSkin_Doombringer';
    case ITEM_SKIN_BRUTE:
        return class'TrSkin_Brute';
    case ITEM_SKIN_BRUTE_MERC:
        return class'TrSkin_Brute_Merc';
    default:
        break;
    }
...
function class<TrFamilyInfo> GetFamilyClass(int ClassId)
{
    switch (ClassId)
    {
    case CLASS_PURCHASE_LIGHT_PATHFINDER:
    case CLASS_TYPE_LIGHT_PATHFINDER:   return class'TrFamilyInfo_Light_Pathfinder';
    case CLASS_PURCHASE_LIGHT_INFILTRATOR:
    case CLASS_TYPE_LIGHT_INFILTRATOR:  return class'TrFamilyInfo_Light_Infiltrator';
    case CLASS_PURCHASE_LIGHT_SENTINEL:
    case CLASS_TYPE_LIGHT_SENTINEL:     return class'TrFamilyInfo_Light_Sentinel';
    case CLASS_PURCHASE_MEDIUM_SOLDIER:
    case CLASS_TYPE_MEDIUM_SOLDIER:     return class'TrFamilyInfo_Medium_Soldier';
    case CLASS_PURCHASE_MEDIUM_RAIDER:
    case CLASS_TYPE_MEDIUM_RAIDER:      return class'TrFamilyInfo_Medium_Raider';
    case CLASS_PURCHASE_MEDIUM_TECHNICIAN:
    case CLASS_TYPE_MEDIUM_TECHNICIAN:  return class'TrFamilyInfo_Medium_Technician';
    case CLASS_PURCHASE_HEAVY_JUGGERNAUGHT:
    case CLASS_TYPE_HEAVY_JUGGERNAUGHT: return class'TrFamilyInfo_Heavy_Juggernaught';
    case CLASS_PURCHASE_HEAVY_DOOMBRINGER:
    case CLASS_TYPE_HEAVY_DOOMBRINGER:  return class'TrFamilyInfo_Heavy_Doombringer';
    case CLASS_PURCHASE_HEAVY_BRUTE:
    case CLASS_TYPE_HEAVY_BRUTE:        return class'TrFamilyInfo_Heavy_Brute';
...
defaultproperties
{
   Name="Default__TrInventoryHelper"
