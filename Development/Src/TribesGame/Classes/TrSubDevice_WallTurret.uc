 ...
 */
class TrSubDevice_WallTurret extends TrSubDevice_Turret;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrSubDevice_WallTurret:FireCameraShake'
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrSubDevice_WallTurret:ForceFeedbackWaveformShooting1'
   MuzzleFlashSocket="WSO_Emit_01"
   MuzzleFlashColor=(B=165,G=225,R=255,A=255)
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_WallTurret'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrSubDevice_WallTurret"
