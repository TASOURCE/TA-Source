 ...
 * 
 */
class TrAttachment_PlasmaCannon extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LiteMed_SpinFusor"
   m_nmHeavyAimProfileName="Heavy_MortarLaucnher"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_PlasmaCannon:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_PlasmaCannon'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_PlasmaCannon"
