 ...
 * 
 */
class TrDevice_ConcussionGrenade extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   InfoPanelDescription="Impact Nitrons deal little damage, but force enemies to drop the flag."
   InfoPanelDamage=4
   InfoPanelRadius=6
   InfoPanelFireRate=5
   InfoPanelClipSize=-1
   ...
   Upgrades(0)=(IconId=6,DatabaseItemId=7881,Modifications=((ModType=29,Value=1.000000)))
   Upgrades(1)=(IconId=7,DatabaseItemId=7882,Modifications=((ModType=55,Value=0.100000)))
   Upgrades(2)=(IconId=6,DatabaseItemId=7883,Modifications=((ModType=29,Value=1.000000)))
   ...
   Name="Default__TrDevice_ConcussionGrenade"
