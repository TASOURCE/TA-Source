class TrDevice_EnergyPack_Soldier extends TrDevice_EnergyPack;

defaultproperties
{
   DBWeaponId=7824
   DBXPActivityId=235
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_EnergyPack_Soldier:FireCameraShake'
   ...
   Upgrades(0)=(IconId=2,DatabaseItemId=8004,Modifications=((ModType=10,Value=5.000000)))
   Upgrades(1)=(IconId=2,DatabaseItemId=8005,Modifications=((ModType=10,Value=5.000000)))
   Upgrades(2)=(IconId=2,DatabaseItemId=8006,Modifications=((ModType=10,Value=5.000000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_EnergyPack_Soldier_Content"
   ...
   Name="Default__TrDevice_EnergyPack_Soldier"
