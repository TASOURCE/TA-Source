 ...
 * 
 */
class TrAttachment_GrenadeLauncher extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LightMed_GrenadeLauncher"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_GrenadeLauncher:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_GrenadeLauncher'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_GrenadeLauncher"
