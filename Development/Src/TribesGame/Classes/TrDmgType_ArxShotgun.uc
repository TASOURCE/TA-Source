class TrDmgType_ArxShotgun extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_ArxShotgun'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_ArxShotgun:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_ArxShotgun:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_ArxShotgun"
