 ...
 * 
 */
class TrDevice_RepairToolEG extends TrDevice_RepairTool;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_RepairToolEG:FireCameraShake'
   ...
   m_sContentDataClassName="TribesGameContent.TrDevice_RepairToolEG_Content"
   AttachmentClass=Class'TribesGame.TrAttachment_RepairToolEG'
   MuzzleFlashLightClass=Class'TribesGame.TrMuzzleFlashLight_RepairToolSD'
   InstantHitDamage(0)=-22.000000
   InstantHitDamage(1)=()
   InstantHitDamageTypes(0)=Class'TribesGame.TrDmgType_RepairToolEG'
   ...
   Name="Default__TrDevice_RepairToolEG"
