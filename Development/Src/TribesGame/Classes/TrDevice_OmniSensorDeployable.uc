 ...
 * 
 */
class TrDevice_OmniSensorDeployable extends TrDevice_Deployable;

defaultproperties
{
   c_DeployableHologramClass=Class'TribesGame.TrDeployableHologram_OmniSensor'
   m_fOtherDeployableProximityCheck=64.000000
   m_WeaponDeployables(0)=Class'TribesGame.TrDeployable_OmniSensor'
   m_WeaponDeployables(1)=()
   m_nCreditCost=500
   m_nIconIndex=3
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_OmniSensorDeployable:FireCameraShake'
   ...
   Name="Default__TrDevice_OmniSensorDeployable"
