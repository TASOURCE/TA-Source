 ...
 * 
 */
class TrDevice_EMPGrenade extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   InfoPanelDescription="EMP Grenades cause damage and Energy drain to those caught in the blast."
   InfoPanelDamage=6
   InfoPanelRadius=7
   InfoPanelFireRate=1
   InfoPanelClipSize=-1
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=8052,Modifications=((ModType=29,Value=1.000000)))
   Upgrades(1)=(IconId=7,DatabaseItemId=8053,Modifications=((ModType=55,Value=0.100000)))
   Upgrades(2)=(IconId=2,DatabaseItemId=8054,Modifications=((ModType=17,Value=0.200000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_EMPGrenade_Content"
   ShotCost(0)=1
   ShotCost(1)=()
   AttachmentClass=Class'TribesGame.TrAttachment_EMPGrenade'
   SmallWeaponsOffset=(X=0.000000,Y=0.000000,Z=-1.500000)
   WideScreenOffsetScaling=1.000000
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_EMPGrenade'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_EMPGrenade"
