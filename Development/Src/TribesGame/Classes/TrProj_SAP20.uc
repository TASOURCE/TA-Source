 ...
 * 
 */
class TrProj_SAP20 extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_SAP20:MyLightEnvironment'
   ...
   DecalWidth=17.000000
   DecalHeight=17.000000
   ...
   Speed=32000.000000
   MaxSpeed=32000.000000
   Damage=600.000000
   MyDamageType=Class'TribesGame.TrDmgType_SAP20'
