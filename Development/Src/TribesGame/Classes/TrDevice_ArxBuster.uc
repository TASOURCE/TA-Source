 ...
 * 
 */
class TrDevice_ArxBuster extends TrDevice_ConstantFire;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_ArxBuster:FireCameraShake'
   ...
   InfoPanelDescription="Designed for use against armored defenses, the Arx Buster fires a triple shot of sticky explosives."
   InfoPanelDamage=7
   InfoPanelRadius=4
   InfoPanelFireRate=6
   InfoPanelClipSize=1
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=8042,Modifications=((ModType=30,Value=6.000000)))
   Upgrades(1)=(IconId=5,DatabaseItemId=8043,Modifications=((ModType=69,Value=0.200000)))
   Upgrades(2)=(IconId=4,DatabaseItemId=8044,Modifications=((ModType=30,Value=6.000000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_ArxBuster_Content"
   MaxAmmoCount=3
   ShotCost(0)=1
   ShotCost(1)=()
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrDevice:ForceFeedbackShootingMedium'
   AttachmentClass=Class'TribesGame.TrAttachment_ArxBuster'
   ...
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_ArxBuster'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_ArxBuster"
