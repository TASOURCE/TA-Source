class TrDmgType_GrenadeXL extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_GrenadeXL'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_GrenadeXL:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_GrenadeXL:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_GrenadeXL"
