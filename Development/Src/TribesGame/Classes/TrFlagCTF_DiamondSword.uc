...
*/
class TrFlagCTF_DiamondSword extends TrFlagCTF
    placeable;

simulated function string GetSpectatorName()
{
	return "Diamond Sword Flag";
}
...
defaultproperties
{
   ...
   PickUpWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrFlagCTF_DiamondSword:ForceFeedbackWaveformPickUp'
   Begin Object Class=SkeletalMeshComponent Name=TheFlagSkelMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrFlagCTF:TheFlagSkelMesh'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrFlagCTF_DiamondSword:FlagLightEnvironment'
   ...
   Name="Default__TrFlagCTF_DiamondSword"
