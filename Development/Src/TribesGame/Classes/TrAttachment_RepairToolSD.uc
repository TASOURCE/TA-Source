 ...
 * 
 */
class TrAttachment_RepairToolSD extends TrAttachment_RepairTool;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrAttachment_RepairTool:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_RepairToolSD:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_RepairToolSD'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_RepairToolSD"
