...
//
class TrExplosiveSpreeMessage extends UTLocalMessage;
...
defaultproperties
{
   SpreeNote(0)="is on an Explosive Spree"
   SpreeNote(1)="is a Demolitions Expert"
   SpreeNote(2)="is the Hurt Locker"
   SelfSpreeNote(0)="You are on an Explosive Spree"
   SelfSpreeNote(1)="You are a Demolitions Expert"
   SelfSpreeNote(2)="You are the Hurt Locker"
   MessageArea=4
   AnnouncementPriority=7
   FontSize=1
   Name="Default__TrExplosiveSpreeMessage"
