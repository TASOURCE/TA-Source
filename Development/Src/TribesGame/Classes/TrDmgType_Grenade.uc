class TrDmgType_Grenade extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_Grenade'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Grenade:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Grenade:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_Grenade"
