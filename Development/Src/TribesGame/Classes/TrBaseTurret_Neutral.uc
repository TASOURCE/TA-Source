class TrBaseTurret_Neutral extends TrDeployable_BaseTurret
    placeable;
...
simulated function Texture2D GetMarker()
{
	if (r_bIsPowered )
	{
		return class'TrHUD'.default.BaseTurretLevel5;
	}
	else
	{
		return class'TrHUD'.default.BaseTurretLevel5_Down;
	}
}
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeployable_BaseTurret:ObjectiveMesh'
      ...
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrBaseTurret_Neutral:MyLightEnvironment'
   ...
   Name="Default__TrBaseTurret_Neutral"
