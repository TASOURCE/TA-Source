class TrDmgType_Shotgun_MKD extends TrDmgType_Bullet
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_Shotgun_MKD'
   NodeDamageScaling=0.800000
   CustomTauntIndex=4
   VehicleDamageScaling=0.700000
   VehicleMomentumScaling=2.000000
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Shotgun_MKD:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Shotgun_MKD:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_Shotgun_MKD"
