 ...
 * 
 */
class TrProj_Chaingun extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_Chaingun:MyLightEnvironment'
   ...
   Damage=95.000000
   MyDamageType=Class'TribesGame.TrDmgType_ChainGun'
