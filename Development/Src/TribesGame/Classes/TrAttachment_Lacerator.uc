 ...
 * 
 */
class TrAttachment_Lacerator extends TrDeviceAttachment;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_Lacerator:SkeletalMeshComponent0.MeshSequenceA'
      AnimSets(0)=None
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_Lacerator'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_Lacerator"
