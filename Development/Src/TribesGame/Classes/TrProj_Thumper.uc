 ...
 * 
 */
class TrProj_Thumper extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_Thumper:MyLightEnvironment'
   ...
   CustomGravityScaling=0.700000
   Speed=3520.000000
   MaxSpeed=8000.000000
   Damage=650.000000
   DamageRadius=360.000000
   MomentumTransfer=85000.000000
   MyDamageType=Class'TribesGame.TrDmgType_Thumper'
