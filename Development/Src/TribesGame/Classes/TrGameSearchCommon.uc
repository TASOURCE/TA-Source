 ...
 */
class TrGameSearchCommon extends OnlineGameSearch
	abstract;
...
defaultproperties
{
   ...
   LocalizedSettings(1)=(Id=1,ValueIndex=1,AdvertisementType=ODAT_OnlineService)
   LocalizedSettings(2)=(Id=2,ValueIndex=2,AdvertisementType=ODAT_OnlineService)
   LocalizedSettingsMappings(1)=(Id=1,Name="LockedServer",ValueMappings=(,(Id=1,bIsWildcard=True)))
   LocalizedSettingsMappings(2)=(Id=2,Name="AllowKeyboard",ValueMappings=(,(Id=1),(Id=2,bIsWildcard=True)))
   Name="Default__TrGameSearchCommon"
