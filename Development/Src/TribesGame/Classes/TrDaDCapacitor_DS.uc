class TrDaDCapacitor_DS extends TrDaDCapacitor
    placeable;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDaDCapacitor:ObjectiveMesh'
      ...
      End Object
      Animations=AnimNodeSequence'TribesGame.Default__TrDaDCapacitor_DS:ObjectiveMesh.AnimNodeSeq0'
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrDaDCapacitor_DS:MyLightEnvironment'
      Name="ObjectiveMesh"
   ...
   Name="Default__TrDaDCapacitor_DS"
