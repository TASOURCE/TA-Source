 ...
 */
class TrDeployable_AntiAirTurret extends TrDeployable_Turret;
...
defaultproperties
{
   ...
   m_fDamageRadius=4000.000000
   m_DeviceClass=Class'TribesGame.TrSubDevice_AntiAirTurret'
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeployable_Turret:ObjectiveMesh'
      ...
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrDeployable_AntiAirTurret:MyLightEnvironment'
   ...
   Name="Default__TrDeployable_AntiAirTurret"
