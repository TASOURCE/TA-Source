 ...
 * 
 */
class TrAttachment_Melee_MC extends TrAttachment_Melee;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrAttachment_Melee:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_Melee_MC:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_Melee_MC'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_Melee_MC"
