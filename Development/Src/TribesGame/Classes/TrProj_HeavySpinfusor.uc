 ...
 * 
 */
class TrProj_HeavySpinfusor extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_HeavySpinfusor:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_HeavySpinfusor'
   ...
   Name="Default__TrProj_HeavySpinfusor"
