 ...
 * 
 */
class TrAttachment_ArxBuster_MKD extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LightMed_GrenadeLaucnher"
   m_nmHeavyAimProfileName="Heavy_GrenadeLaucnher"
   m_LightMed3pPawnAnimSets(0)=None
   m_LightMed3pPawnAnimSets(1)=None
   m_Heavy3pPawnAnimSets(0)=None
   m_Heavy3pPawnAnimSets(1)=None
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_ArxBuster_MKD:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_ArxBuster_MKD'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_ArxBuster_MKD"
