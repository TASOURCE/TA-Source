class TrPowerGenerator_BloodEagle extends TrPowerGenerator
    placeable;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrPowerGenerator:ObjectiveMesh'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrPowerGenerator_BloodEagle:MyLightEnvironment'
   ...
   Name="Default__TrPowerGenerator_BloodEagle"
