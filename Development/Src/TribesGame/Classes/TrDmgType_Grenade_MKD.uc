class TrDmgType_Grenade_MKD extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_Grenade_MKD'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Grenade_MKD:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Grenade_MKD:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_Grenade_MKD"
