 ...
 * 
 */
class TrDeployable_OmniSensor extends TrDeployable_Sensor;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeployable_Sensor:ObjectiveMesh'
      ...
      End Object
      Animations=AnimNodeSequence'TribesGame.Default__TrDeployable_OmniSensor:ObjectiveMesh.AnimNodeSeq0'
      AnimSets(0)=None
      bHasPhysicsAssetInstance=True
      bOverrideAttachmentOwnerVisibility=True
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrDeployable_OmniSensor:MyLightEnvironment'
      CollideActors=True
      BlockActors=True
   ...
   Name="Default__TrDeployable_OmniSensor"
