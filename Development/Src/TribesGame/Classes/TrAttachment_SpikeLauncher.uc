 ...
 * 
 */
class TrAttachment_SpikeLauncher extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LiteMed_SpinFusor"
   m_nmHeavyAimProfileName="Heavy_Pistol_1h"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_SpikeLauncher:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_SpikeLauncher'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_SpikeLauncher"
