 ...
 */
class TrSubDevice_BaseTurret extends TrSubDevice_Turret;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrSubDevice_BaseTurret:FireCameraShake'
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrSubDevice_BaseTurret:ForceFeedbackWaveformShooting1'
   MuzzleFlashSocket="WSO_Emit_01"
   MuzzleFlashColor=(B=255,G=120,R=255,A=255)
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_BaseTurret'
   WeaponProjectiles(1)=()
   FireInterval(0)=2.500000
   FireInterval(1)=()
   InstantHitDamageTypes(0)=Class'TribesGame.TrDmgType_BaseTurret'
   ...
   Name="Default__TrSubDevice_BaseTurret"
