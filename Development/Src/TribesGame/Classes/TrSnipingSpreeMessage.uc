...
//
class TrSnipingSpreeMessage extends UTLocalMessage;
...
defaultproperties
{
   SpreeNote(0)="is on a Sniping Spree"
   SpreeNote(1)="is a Marksman"
   SpreeNote(2)="is a Sharpshooter"
   SelfSpreeNote(0)="You are on a Sniping Spree"
   SelfSpreeNote(1)="You are a Marksman"
   SelfSpreeNote(2)="You are a Sharpshooter"
   MessageArea=4
   AnnouncementPriority=7
   FontSize=1
   Name="Default__TrSnipingSpreeMessage"
