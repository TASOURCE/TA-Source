class TrDmgType_PlasmaGun extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_PlasmaGun'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_PlasmaGun:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_PlasmaGun:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_PlasmaGun"
