 ...
 * 
 */
class TrDevice_HeavyAPGrenade extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=8083,Modifications=((ModType=29,Value=1.000000)))
   Upgrades(1)=(IconId=7,DatabaseItemId=8084,Modifications=((ModType=55,Value=0.100000)))
   Upgrades(2)=(IconId=7,DatabaseItemId=8085,Modifications=((ModType=55,Value=0.100000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_HeavyAPGrenade_Content"
   ShotCost(0)=1
   ShotCost(1)=()
   AttachmentClass=Class'TribesGame.TrAttachment_HeavyAPGrenade'
   SmallWeaponsOffset=(X=0.000000,Y=0.000000,Z=-1.500000)
   WideScreenOffsetScaling=1.000000
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_HeavyAPGrenade'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_HeavyAPGrenade"
