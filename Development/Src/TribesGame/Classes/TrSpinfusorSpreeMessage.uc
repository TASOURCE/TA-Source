...
//
class TrSpinfusorSpreeMessage extends UTLocalMessage;
...
defaultproperties
{
   SpreeNote(0)="is on a Classic Spree"
   SpreeNote(1)="is a Disc Jockey"
   SpreeNote(2)="is a Tribal Fanatic"
   SelfSpreeNote(0)="You are on a Classic Spree"
   SelfSpreeNote(1)="You are a Disc Jockey"
   SelfSpreeNote(2)="You are a Tribal Fanatic"
   MessageArea=4
   AnnouncementPriority=7
   FontSize=1
   Name="Default__TrSpinfusorSpreeMessage"
