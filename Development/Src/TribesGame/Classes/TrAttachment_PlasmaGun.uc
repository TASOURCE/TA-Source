 ...
 * 
 */
class TrAttachment_PlasmaGun extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LiteMed_SMG"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_PlasmaGun:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_PlasmaGun'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_PlasmaGun"
