 ...
 * 
 */
class TrDevice_STGrenade extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   InfoPanelDescription="Explosive Nitrons deal extra damage and knockback, but do not force flag drops."
   InfoPanelDamage=7
   InfoPanelRadius=4
   InfoPanelFireRate=5
   InfoPanelClipSize=-1
   ...
   Upgrades(0)=(IconId=6,DatabaseItemId=7888,Modifications=((ModType=29,Value=1.000000)))
   Upgrades(1)=(IconId=7,DatabaseItemId=7889,Modifications=((ModType=55,Value=0.100000)))
   Upgrades(2)=(IconId=6,DatabaseItemId=7890,Modifications=((ModType=29,Value=1.000000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_STGrenade_Content"
   ShotCost(0)=1
   ShotCost(1)=()
   AttachmentClass=Class'TribesGame.TrAttachment_STGrenade'
   SmallWeaponsOffset=(X=0.000000,Y=0.000000,Z=-1.500000)
   WideScreenOffsetScaling=1.000000
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_STGrenade'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_STGrenade"
