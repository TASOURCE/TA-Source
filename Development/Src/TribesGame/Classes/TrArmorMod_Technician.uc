class TrArmorMod_Technician extends TrArmorMod;

defaultproperties
{
   DBWeaponId=7840
   DBXPActivityId=190
   m_FireCameraShake=CameraShake'TribesGame.Default__TrArmorMod_Technician:FireCameraShake'
   ...
   Upgrades(0)=(IconId=10,DatabaseItemId=8037,Modifications=((ModType=49,Value=0.250000)))
   Upgrades(1)=(IconId=8,DatabaseItemId=8038,Modifications=((ModType=2,Value=50.000000)))
   Upgrades(2)=(IconId=8,DatabaseItemId=8039,Modifications=((ModType=39,Value=0.250000)))
   Upgrades(3)=(IconId=2,DatabaseItemId=8040,Modifications=((ModType=10,Value=10.000000)))
   Upgrades(4)=(IconId=8,DatabaseItemId=8041,Modifications=((ModType=2,Value=50.000000)))
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrArmorMod_Technician:ForceFeedbackWaveformShooting1'
   ...
   Name="Default__TrArmorMod_Technician"
