class TrDmgType_ProximityGrenade extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_ProximityGrenade'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_ProximityGrenade:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_ProximityGrenade:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_ProximityGrenade"
