 ...
 * 
 */
class TrDevice_TCNG extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   InfoPanelDescription="A balanced trade of damage and radius."
   InfoPanelDamage=9
   InfoPanelRadius=5
   InfoPanelFireRate=5
   InfoPanelClipSize=-1
   ...
   m_sContentDataClassName="TribesGameContent.TrDevice_TCNG_Content"
   ShotCost(0)=1
   ShotCost(1)=()
   ...
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_TCNG'
   WeaponProjectiles(1)=()
