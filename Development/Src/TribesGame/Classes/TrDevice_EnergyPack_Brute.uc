class TrDevice_EnergyPack_Brute extends TrDevice_EnergyPack;

defaultproperties
{
   DBWeaponId=7830
   DBXPActivityId=224
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_EnergyPack_Brute:FireCameraShake'
   ...
   Upgrades(0)=(IconId=2,DatabaseItemId=8141,Modifications=((ModType=10,Value=5.000000)))
   Upgrades(1)=(IconId=2,DatabaseItemId=8142,Modifications=((ModType=10,Value=5.000000)))
   Upgrades(2)=(IconId=2,DatabaseItemId=8143,Modifications=((ModType=10,Value=5.000000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_EnergyPack_Brute_Content"
   ...
   Name="Default__TrDevice_EnergyPack_Brute"
