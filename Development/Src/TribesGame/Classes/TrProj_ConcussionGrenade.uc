 ...
 * 
 */
class TrProj_ConcussionGrenade extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_ConcussionGrenade:MyLightEnvironment'
   ...
   Damage=300.000000
   DamageRadius=460.000000
   MomentumTransfer=54000.000000
   MyDamageType=Class'TribesGame.TrDmgType_ConcussionGrenade'
   ...
   Name="Default__TrProj_ConcussionGrenade"
