 ...
 * 
 */
class TrAttachment_SAP20 extends TrDeviceAttachment;
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_SAP20:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   MuzzleFlashColor=(B=100,G=180,R=255,A=255)
   ...
   WeaponClass=Class'TribesGame.TrDevice_SAP20'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_SAP20"
