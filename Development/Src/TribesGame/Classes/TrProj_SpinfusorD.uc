 ...
 * 
 */
class TrProj_SpinfusorD extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_SpinfusorD:MyLightEnvironment'
   ...
   ExplosionLightClass=Class'TribesGame.TrExplosionLight_SpinfusorD'
   bWideCheck=True
   ...
   MyDamageType=Class'TribesGame.TrDmgType_SpinfusorD'
   ...
   Name="Default__TrProj_SpinfusorD"
