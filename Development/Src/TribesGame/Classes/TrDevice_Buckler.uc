 ...
 * 
 */
class TrDevice_Buckler extends TrDevice_ConstantFire;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_Buckler:FireCameraShake'
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=8265,Modifications=((ModType=30,Value=6.000000)))
   Upgrades(1)=(IconId=5,DatabaseItemId=8266,Modifications=((ModType=69,Value=0.200000)))
   Upgrades(2)=(IconId=4,DatabaseItemId=8267,Modifications=((ModType=30,Value=6.000000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_Buckler_Content"
   MaxAmmoCount=3
   ShotCost(0)=1
   ShotCost(1)=()
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrDevice:ForceFeedbackShootingMedium'
   AttachmentClass=Class'TribesGame.TrAttachment_Buckler'
   ...
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_Buckler'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_Buckler"
