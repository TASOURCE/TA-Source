 ...
 * 
 */
class TrProj_SpikeLauncherThird extends TrProj_Grenade;

defaultproperties
{
   m_fExplosionTime=0.500000
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProj_Grenade:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_SpikeLauncherThird:MyLightEnvironment'
   ...
   Name="Default__TrProj_SpikeLauncherThird"
