 ...
 * 
 */
class TrProj_Spinfusor extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_Spinfusor:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_SpinfusorM'
   ...
   Name="Default__TrProj_Spinfusor"
