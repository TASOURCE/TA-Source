 ...
 * 
 */
class TrProj_Twinfusor extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_Twinfusor:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_Twinfusor'
   ...
   Name="Default__TrProj_Twinfusor"
