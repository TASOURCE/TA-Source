class TrDmgType_TCNG_MKD extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_TCNG_MKD'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_TCNG_MKD:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_TCNG_MKD:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_TCNG_MKD"
