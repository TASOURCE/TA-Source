 ...
 * 
 */
class TrAttachment_SaberLauncher_MKD extends TrDeviceAttachment;

defaultproperties
{
   m_nmHeavyAimProfileName="Heavy_SabreLauncher"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_SaberLauncher_MKD:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   WeaponClass=Class'TribesGame.TrDevice_SaberLauncher_MKD'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_SaberLauncher_MKD"
