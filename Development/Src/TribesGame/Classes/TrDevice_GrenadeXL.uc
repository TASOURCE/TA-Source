 ...
 * 
 */
class TrDevice_GrenadeXL extends TrDevice_AutoFire;
...
defaultproperties
{
   ...
   InfoPanelDescription="This Grenade has a larger than normal blast radius. Stand back."
   InfoPanelDamage=9
   InfoPanelRadius=8
   InfoPanelFireRate=5
   InfoPanelClipSize=-1
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=7998,Modifications=((ModType=29,Value=1.000000)))
   Upgrades(1)=(IconId=7,DatabaseItemId=7999,Modifications=((ModType=55,Value=0.100000)))
   Upgrades(2)=(IconId=5,DatabaseItemId=8000,Modifications=((ModType=68,Value=0.200000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_GrenadeXL_Content"
   ShotCost(0)=1
   ShotCost(1)=()
   ...
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_GrenadeXL'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_GrenadeXL"
