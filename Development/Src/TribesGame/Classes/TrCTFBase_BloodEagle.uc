class TrCTFBase_BloodEagle extends TrCTFBase
	placeable;

simulated function string GetSpectatorName()
{
	return "Blood Eagle Flag Stand";
}
...
defaultproperties
{
   Begin Object Class=SkeletalMeshComponent Name=FlagStand Archetype=SkeletalMeshComponent'TribesGame.Default__TrCTFBase:FlagStand'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrCTFBase_BloodEagle:FlagBaseLightEnvironment'
   ...
   FlagType=Class'TribesGame.TrFlagCTF_BloodEagle'
   DefenderTeamIndex=0
   ...
   Name="Default__TrCTFBase_BloodEagle"
