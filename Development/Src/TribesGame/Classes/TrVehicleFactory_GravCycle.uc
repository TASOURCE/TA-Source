class TrVehicleFactory_GravCycle extends UTVehicleFactory;

defaultproperties
{
   VehicleClassPath="TribesGame.TrVehicle_GravCycle"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SVehicleMesh Archetype=SkeletalMeshComponent'UTGame.Default__UTVehicleFactory:SVehicleMesh'
      ...
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrVehicleFactory_GravCycle:MyLightEnvironment'
      HiddenGame=True
   ...
   Name="Default__TrVehicleFactory_GravCycle"
