 ...
 * 
 */
class TrDevice_BackupGeneratorDeployable extends TrDevice_Deployable;

defaultproperties
{
   c_DeployableHologramClass=Class'TribesGame.TrDeployableHologram_BackupGenerator'
   m_fOtherDeployableProximityCheck=32.000000
   m_WeaponDeployables(0)=Class'TribesGame.TrDeployable_BackupGenerator'
   m_WeaponDeployables(1)=()
   m_nCreditCost=1000
   m_nIconIndex=15
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_BackupGeneratorDeployable:FireCameraShake'
   ...
   Name="Default__TrDevice_BackupGeneratorDeployable"
