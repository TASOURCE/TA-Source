 ...
 */
class TrSubDevice_AntiAirTurret extends TrSubDevice_Turret;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrSubDevice_AntiAirTurret:FireCameraShake'
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrSubDevice_AntiAirTurret:ForceFeedbackWaveformShooting1'
   MuzzleFlashSocket="WSO_Emit_01"
   MuzzleFlashColor=(B=165,G=225,R=255,A=255)
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_AntiAirTurret'
   WeaponProjectiles(1)=()
   FireInterval(0)=2.000000
   FireInterval(1)=()
   InstantHitDamageTypes(0)=Class'TribesGame.TrDmgType_AntiAirTurret'
   ...
   Name="Default__TrSubDevice_AntiAirTurret"
