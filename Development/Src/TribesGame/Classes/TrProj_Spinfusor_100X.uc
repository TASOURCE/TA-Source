 ...
 * 
 */
class TrProj_Spinfusor_100X extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_Spinfusor_100X:MyLightEnvironment'
   ...
   m_fDirectHitMultiplier=1.100000
   ...
   MyDamageType=Class'TribesGame.TrDmgType_Spinfusor_100X'
   ...
   Name="Default__TrProj_Spinfusor_100X"
