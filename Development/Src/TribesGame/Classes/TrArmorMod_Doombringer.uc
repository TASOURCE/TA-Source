class TrArmorMod_Doombringer extends TrArmorMod;

defaultproperties
{
   DBWeaponId=7843
   DBXPActivityId=184
   m_FireCameraShake=CameraShake'TribesGame.Default__TrArmorMod_Doombringer:FireCameraShake'
   ...
   Upgrades(0)=(IconId=8,DatabaseItemId=8119,Modifications=((ModType=2,Value=100.000000)))
   Upgrades(1)=(IconId=10,DatabaseItemId=8120,Modifications=((ModType=49,Value=0.250000)))
   Upgrades(2)=(IconId=2,DatabaseItemId=8121,Modifications=((ModType=10,Value=10.000000)))
   Upgrades(3)=(IconId=8,DatabaseItemId=8122,Modifications=((ModType=39,Value=0.250000)))
   Upgrades(4)=(IconId=8,DatabaseItemId=8123,Modifications=((ModType=2,Value=100.000000)))
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrArmorMod_Doombringer:ForceFeedbackWaveformShooting1'
   ...
   Name="Default__TrArmorMod_Doombringer"
