 ...
 * 
 */
class TrProj_EMPGrenade extends TrProj_Grenade;
...
defaultproperties
{
   ...
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProj_Grenade:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_EMPGrenade:MyLightEnvironment'
   ...
   MyDamageType=Class'TribesGame.TrDmgType_EMPGrenade'
   ...
   Name="Default__TrProj_EMPGrenade"
