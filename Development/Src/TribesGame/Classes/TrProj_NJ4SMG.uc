 ...
 * 
 */
class TrProj_NJ4SMG extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_NJ4SMG:MyLightEnvironment'
   ...
   Damage=75.000000
   MyDamageType=Class'TribesGame.TrDmgType_NJ4SMG'
