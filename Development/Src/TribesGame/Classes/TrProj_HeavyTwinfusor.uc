 ...
 * 
 */
class TrProj_HeavyTwinfusor extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_HeavyTwinfusor:MyLightEnvironment'
   ...
   m_fInstigatorMomentumTransferMultiplier=0.500000
   ...
   MyDamageType=Class'TribesGame.TrDmgType_HeavyTwinfusor'
   ...
   Name="Default__TrProj_HeavyTwinfusor"
