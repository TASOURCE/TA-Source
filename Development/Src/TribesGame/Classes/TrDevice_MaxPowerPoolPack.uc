 ...
 *
 */
class TrDevice_MaxPowerPoolPack extends TrDevice_Pack;
...
defaultproperties
{
   ...
   m_nCreditCost=150
   m_nIconIndex=7
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_MaxPowerPoolPack:FireCameraShake'
   ...
   Name="Default__TrDevice_MaxPowerPoolPack"
