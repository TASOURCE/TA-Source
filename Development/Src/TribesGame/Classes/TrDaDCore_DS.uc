class TrDaDCore_DS extends TrDaDCore
    placeable;
...
simulated event PostBeginPlay()
{
	...
	if( Role == ROLE_Authority )
	{
		...
		if( TrGRI != none )
		{
			...
			TrGRI.r_DaDCapacitorDS[0] = m_Capacitors[0];
			TrGRI.r_DaDCapacitorDS[1] = m_Capacitors[1];
			TrGRI.r_DaDCapacitorDS[2] = m_Capacitors[2];
		}
	}
}
...
defaultproperties
{
   ...
   Begin Object Class=SkeletalMeshComponent Name=ObjectiveMesh Archetype=SkeletalMeshComponent'TribesGame.Default__TrDaDCore:ObjectiveMesh'
      ...
      End Object
      Animations=AnimNodeSequence'TribesGame.Default__TrDaDCore_DS:ObjectiveMesh.AnimNodeSeq0'
      ReplacementPrimitive=None
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrDaDCore_DS:MyLightEnvironment'
      Name="ObjectiveMesh"
