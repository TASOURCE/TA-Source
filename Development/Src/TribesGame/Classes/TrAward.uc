...
/** The preset amounts needed to reach each tier */
var int TierLimit[3];

/** Heuristic for determining the order of awards on the list */
var float Weight;

/** The different titles for each tier of this award */
var localized string TitleTier1;
var localized string TitleTier2;
var localized string TitleTier3;

var localized string Units;

defaultproperties
{
   Name="Default__TrAward"
