class TrDmgType_SpikeGrenade extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_SpikeGrenade'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_SpikeGrenade:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_SpikeGrenade:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_SpikeGrenade"
