class TrDmgType_Melee extends TrDmgType_Base
	abstract;
...
defaultproperties
{
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Melee:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_Melee:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_Melee"
