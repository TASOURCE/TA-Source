 ...
 * 
 */
class TrDevice_GrenadeLauncher extends TrDevice_ConstantFire;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_GrenadeLauncher:FireCameraShake'
   m_TinyWeaponsOffset=(X=12.000000,Y=1.000000,Z=-4.000000)
   m_MainMenuPaperDollInfo=(Rotation=(Pitch=4004,Yaw=16384,Roll=0),Scale=2.300000)
   InfoPanelDescription="The Grenades from this launcher explode on contact with enemies, and its expanded clip and radius give it more flexibility than the Arx Buster."
   InfoPanelDamage=6
   InfoPanelRadius=7
   InfoPanelFireRate=4
   InfoPanelClipSize=2
   ...
   Upgrades(0)=(IconId=4,DatabaseItemId=8045,Modifications=((ModType=30,Value=8.000000)))
   Upgrades(1)=(IconId=4,DatabaseItemId=8046,Modifications=((ModType=64,Value=1.000000)))
   Upgrades(2)=(IconId=4,DatabaseItemId=8047,Modifications=((ModType=30,Value=8.000000)))
   m_sContentDataClassName="TribesGameContent.TrDevice_GrenadeLauncher_Content"
   MaxAmmoCount=4
   ShotCost(0)=1
   ShotCost(1)=()
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrDevice:ForceFeedbackShootingMedium'
   AttachmentClass=Class'TribesGame.TrAttachment_GrenadeLauncher'
   MuzzleFlashSocket="WSO_Emit_01"
   MuzzleFlashColor=(B=255,G=120,R=255,A=255)
   PlayerViewOffset=(X=20.000000,Y=3.000000,Z=-7.000000)
   SmallWeaponsOffset=(X=7.000000,Y=3.000000,Z=1.200000)
   WideScreenOffsetScaling=1.000000
   WidescreenRotationOffset=(Pitch=0,Yaw=0,Roll=0)
   WeaponFireTypes(0)=EWFT_Projectile
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_GrenadeLauncher'
   WeaponProjectiles(1)=()
   ...
   Name="Default__TrDevice_GrenadeLauncher"
