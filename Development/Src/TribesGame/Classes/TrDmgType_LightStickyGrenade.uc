class TrDmgType_LightStickyGrenade extends TrDmgType_Explosive
	abstract;
...
defaultproperties
{
   ...
   m_fDamageMultiplierAgainstArmor=3.200000
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_LightStickyGrenade'
   ...
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_LightStickyGrenade:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_LightStickyGrenade:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_LightStickyGrenade"
