 ...
 * 
 */
class TrDevice_ARC8 extends TrDevice_ConstantFire;
...
defaultproperties
{
   ...
   m_FireCameraShake=CameraShake'TribesGame.Default__TrDevice_ARC8:FireCameraShake'
   m_TinyWeaponsOffset=(X=20.000000,Y=2.000000,Z=-7.000000)
   m_MainMenuPaperDollInfo=(Translation=(X=10.000000,Y=7.000000,Z=50.000000),Rotation=(Pitch=4004,Yaw=16384,Roll=0),Scale=2.700000)
   m_sContentDataClassName="TribesGameContent.TrDevice_ARC8_Content"
   MaxAmmoCount=3
   ShotCost(0)=1
   ShotCost(1)=()
   WeaponFireWaveForm=ForceFeedbackWaveform'TribesGame.Default__TrDevice:ForceFeedbackShootingMedium'
   AttachmentClass=Class'TribesGame.TrAttachment_ARC8'
   ...
   WeaponFireTypes(1)=()
   WeaponProjectiles(0)=Class'TribesGame.TrProj_ARC8'
   WeaponProjectiles(1)=()
