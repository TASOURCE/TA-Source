 ...
 * 
 */
class TrAttachment_SniperRifle_MKD extends TrDeviceAttachment;

defaultproperties
{
   m_nmLightMedAimProfileName="LightMed_EnergySniperRifle"
   m_bSpawnTracerBeams=True
   m_LightMed3pPawnAnimSets(0)=None
   m_nmRidingAsPassengerFireAnimName="ADD_FireSingle"
   ...
   Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0 Archetype=SkeletalMeshComponent'TribesGame.Default__TrDeviceAttachment:SkeletalMeshComponent0'
      ...
      End Object
      Animations=UTAnimNodeSequence'TribesGame.Default__TrAttachment_SniperRifle_MKD:SkeletalMeshComponent0.MeshSequenceA'
      bForceRefpose=1
   ...
   ImpactEffects(1)=(MaterialType="Concrete",DecalMaterials=(None),DecalWidth=30.000000,DecalHeight=30.000000)
   ImpactEffects(2)=(MaterialType="Dirt")
   ImpactEffects(3)=(MaterialType="Grass")
   ImpactEffects(4)=(MaterialType="Metal",DecalMaterials=(None),DecalWidth=25.000000,DecalHeight=25.000000)
   ImpactEffects(5)=(MaterialType="MetalGrate",DecalMaterials=(None),DecalWidth=15.000000,DecalHeight=15.000000)
   ImpactEffects(6)=(MaterialType="Rock",DecalMaterials=(None),DecalWidth=22.000000,DecalHeight=22.000000)
   ...
   DefaultImpactEffect=(DecalMaterials=(None),DecalWidth=30.000000,DecalHeight=30.000000)
   WeaponClass=Class'TribesGame.TrDevice_SniperRifle_MKD'
   Components(0)=WeaponLoopSound
   Name="Default__TrAttachment_SniperRifle_MKD"
