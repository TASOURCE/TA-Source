 ...
 * 
 */
class TrProj_ThrowingKnives extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_ThrowingKnives:MyLightEnvironment'
   ...
   m_fDirectHitMultiplier=3.750000
   ...
   DecalWidth=15.000000
   DecalHeight=15.000000
   ...
   MyDamageType=Class'TribesGame.TrDmgType_ThrowingKnives'
   ...
   Name="Default__TrProj_ThrowingKnives"
