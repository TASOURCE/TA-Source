class TrDmgType_SAP20 extends TrDmgType_Bullet
	abstract;
...
defaultproperties
{
   ...
   DamageWeaponClass=Class'TribesGame.TrDevice_SAP20'
   NodeDamageScaling=0.800000
   CustomTauntIndex=4
   VehicleDamageScaling=0.700000
   VehicleMomentumScaling=2.000000
   DamagedFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_SAP20:ForceFeedbackWaveform0'
   KilledFFWaveform=ForceFeedbackWaveform'TribesGame.Default__TrDmgType_SAP20:ForceFeedbackWaveform1'
   Name="Default__TrDmgType_SAP20"
