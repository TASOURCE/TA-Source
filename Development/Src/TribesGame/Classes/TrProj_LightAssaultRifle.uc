 ...
 * 
 */
class TrProj_LightAssaultRifle extends TrProjectile;
...
defaultproperties
{
   Begin Object Class=StaticMeshComponent Name=ProjectileMeshComp Archetype=StaticMeshComponent'TribesGame.Default__TrProjectile:ProjectileMeshComp'
      ...
      LightEnvironment=DynamicLightEnvironmentComponent'TribesGame.Default__TrProj_LightAssaultRifle:MyLightEnvironment'
   ...
   Damage=80.000000
   MyDamageType=Class'TribesGame.TrDmgType_LightAssaultRifle'
   ...
   Name="Default__TrProj_LightAssaultRifle"
